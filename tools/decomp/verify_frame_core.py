...
SEEDS = {
    ...
    'ZeroSlotsGatedDispatch': [
        ('state 3 skips the phase reset', {'g_baseSel': 0x2e4000,
            'g_fightGroupHead': 0x2e4400, '@0xb91030': 3,
            'g_walkCallback': 0x99, 'g_framePauseFlag': 0,
            '@0x48e0e0': b'\xc3', '@0x490fc0': b'\xc3'}),
        ('state 0 runs it', {'g_baseSel': 0x2e4000,
            'g_fightGroupHead': 0x2e4400, '@0xb91030': 0,
            'g_walkCallback': 0x99, 'g_framePauseFlag': 0,
            '@0x48e0e0': b'\xc3', '@0x490fc0': b'\xc3'}),
        ('pause inside the phase reset', {'g_baseSel': 0x2e4000,
            'g_fightGroupHead': 0x2e4400, '@0xb91030': 0,
            'g_walkCallback': 0x99, 'g_framePauseFlag': 0,
            '@0x48e0e0': b'\xc7\x05\x6c\x1e\x54\x00\x01\x00\x00\x00\xc3'}),
        ('pause inside the dispatch', {'g_baseSel': 0x2e4000,
            'g_fightGroupHead': 0x2e4400, '@0xb91030': 4,
            'g_walkCallback': 0x99, 'g_framePauseFlag': 0,
            '@0x490fc0': b'\xc7\x05\x6c\x1e\x54\x00\x01\x00\x00\x00\xc3'}),
    ],
    'StateDispatchTable': [
        ('state present: the deref pass', {'g_baseSel': 0x2e4000,
            '@0xb90030': 5, 'g_walkCallback': 0, 'g_currentNodeIdx': 0x777,
            'g_framePauseFlag': 0, '@0x494800': b'\xc3'}),
        ('pause inside the deref pass', {'g_baseSel': 0x2e4000,
            '@0xb90030': 5, 'g_walkCallback': 0, 'g_currentNodeIdx': 0x777,
            'g_framePauseFlag': 0,
            '@0x494800': b'\xc7\x05\x6c\x1e\x54\x00\x01\x00\x00\x00\xc3'}),
        ('no state, player 1 lookup', {'g_baseSel': 0x2e4000,
            '@0xb90030': 0, '@0x538038': 0x2e4000, 'g_dlNalt1': 3,
            'g_dlNalt2': 9, 'g_walkCallback': 0, 'g_currentNodeIdx': 0,
            '@0x543054': 0xabc}),
        ('no state, player 2 lookup', {'g_baseSel': 0x2e4000,
            '@0xb90030': 0, '@0x538038': 0x999, 'g_dlNalt1': 3,
            'g_dlNalt2': 9, 'g_walkCallback': 0, 'g_currentNodeIdx': 0,
            '@0x54306c': 0xdef}),
        ('character 0x10 remaps to 2', {'g_baseSel': 0x2e4000,
            '@0xb90030': 0, '@0x538038': 0x2e4000, 'g_dlNalt1': 0x10,
            'g_walkCallback': 0, 'g_currentNodeIdx': 0, '@0x543050': 0x222}),
        ('character 0x11 remaps to 7', {'g_baseSel': 0x2e4000,
    ...
    'RoundReset': [
        ('plain reset', {'g_framePauseFlag': 0, 'g_xformDirtyFlags': 0,
            '@0x52aac4': 0, '@0x537f30': 0, '@0x53a498': 0x77,
            'g_walkCallback': 0, '@0x53a3e4': 0, '@0x53a474': 0,
            '@0x423870': b'\xc3', '@0x4225f0': b'\xc3', '@0x4238b0': b'\xc3',
            '@0x422720': b'\xc3'}),
        ('dirty bit 0: the state copy', {'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 1, '@0x52aac4': 0, '@0x537f30': 0,
            '@0x53a498': 0x77, 'g_walkCallback': 0,
            '@0x423870': b'\xc3', '@0x4225f0': b'\xc3', '@0x4238b0': b'\xc3',
            '@0x422720': b'\xc3'}),
        ('tick flag 2: the zero-four check', {'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 0, '@0x52aac4': 2, '@0x537f30': 0,
            '@0x53a498': 0x77, 'g_walkCallback': 0,
            '@0x423870': b'\xc3', '@0x4225f0': b'\xc3', '@0x4238b0': b'\xc3',
            '@0x422720': b'\xc3'}),
        ('hit phase 1 clears the pair', {'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 0, '@0x52aac4': 0, '@0x537f30': 1,
            '@0x53a6e0': 0x11, '@0x537ea4': 0x22, '@0x53a498': 0x77,
            'g_walkCallback': 0,
            '@0x423870': b'\xc3', '@0x4225f0': b'\xc3', '@0x4238b0': b'\xc3',
            '@0x422720': b'\xc3'}),
        ('pause in the dirty toggle', {'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 0, '@0x52aac4': 0, '@0x537f30': 0,
            '@0x423870': b'\xc7\x05\x6c\x1e\x54\x00\x01\x00\x00\x00\xc3'}),
        ('pause in the tri-branch tail', {'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 0, '@0x52aac4': 0, '@0x537f30': 0,
            '@0x53a498': 0x77, 'g_walkCallback': 0,
            '@0x423870': b'\xc3', '@0x4225f0': b'\xc3', '@0x4238b0': b'\xc3',
            '@0x422720': b'\xc7\x05\x6c\x1e\x54\x00\x01\x00\x00\x00\xc3'}),
    ],
    # The scene-build entry: the DC260 tree walk BUILDS the node, then its
    # element list is installed and walked; a not-found from the walk falls
    # back to the chain insert and publishes null.
    'MStackPushDispatchBitGate': [
        ('tree walk finds nothing', {'g_matrixStackTop': 0x2e5000,
            'g_xformEntityIdx': 0x111, 'g_currentNodeIdx': 0,
            'g_fightGroupHead': 0, 'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 0,
            '@0x407030': b'\x83\x0d\x8c\x20\x54\x00\x04\xc3'}),
        ('built, list installed and walked', {'g_matrixStackTop': 0x2e5000,
            'g_xformEntityIdx': 0x111, 'g_currentNodeIdx': 0,
            'g_fightGroupHead': 0, 'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 0,
            '@0x407030': b'\x83\x25\x8c\x20\x54\x00\xfb'
                         b'\xc7\x05\x44\x20\x54\x00\x00\x41\x2e\x00\xc3',
            '@0x408600': b'\xc3', '@0x4088b0': b'\xc3', '@0x406790': b'\xc3'}),
        ('walk not-found: the insert fallback', {'g_matrixStackTop': 0x2e5000,
            'g_xformEntityIdx': 0x111, 'g_currentNodeIdx': 0,
            'g_fightGroupHead': 0, 'g_framePauseFlag': 0,
            'g_xformDirtyFlags': 0,
            '@0x407030': b'\x83\x25\x8c\x20\x54\x00\xfb'
            ...
            '@0x406790': b'\xc3'}),
        ('pause inside the tree walk', {'g_matrixStackTop': 0x2e5000,
            'g_xformEntityIdx': 0x111, 'g_currentNodeIdx': 0,
            'g_framePauseFlag': 0, 'g_xformDirtyFlags': 0,
            '@0x407030': b'\xc7\x05\x6c\x1e\x54\x00\x01\x00\x00\x00\xc3'}),
    ],
    # The pool stocker: one 200-node list via the list builder, then a run
    # of empty list headers via the slot walk. Both callees run LIVE - the
    # point is that the headers come out right.
    'BootInitChainHeavy': [
        ('stocks the pools', {'g_framePauseFlag': 0, 'g_audioInitScaled': 9,
            'g_dispatchSave82': 0x2e4000, 'g_bootChainPair0': 0x2e4400,
            'g_bootChainPair1': 0x2e4800, 'g_currentNodeIdx': 0,
            'g_xformDirtyFlags': 0, 'g_matrixStackTop': 0x2e5000,
            '@0x4bd570': b'\xc3', '@0x4bd8d0': b'\xc3'}),
        ('pause in the geo pre-pass', {'g_framePauseFlag': 0,
            'g_audioInitScaled': 9,
            '@0x4bd570': b'\xc7\x05\x6c\x1e\x54\x00\x01\x00\x00\x00\xc3'}),
    ],
    'LinkedListBuilder': [
        ('builds a six-node list', {'g_currentNodeIdx': 0x2e4000,
            'g_eventQueueTotal': 0x2e4400, 'g_eventQueueEnd': 6,
            'g_xformEntityIdx': 2, 'g_pendingNodeType': 0x21,
            'g_framePauseFlag': 0, 'g_xformDirtyFlags': 0,
            'g_matrixStackTop': 0x2e5000}),
        ('single node', {'g_currentNodeIdx': 0x2e4000,
            'g_eventQueueTotal': 0x2e4400, 'g_eventQueueEnd': 1,
            'g_xformEntityIdx': 0, 'g_pendingNodeType': 0x21,
            'g_framePauseFlag': 0, 'g_xformDirtyFlags': 0,
            'g_matrixStackTop': 0x2e5000}),
        ('builds a three-node list', {'g_currentNodeIdx': 0x2e4000,
            'g_eventQueueTotal': 0x2e4400, 'g_eventQueueEnd': 3,
            'g_xformEntityIdx': 0, 'g_pendingNodeType': 0x21,
            'g_framePauseFlag': 0, 'g_xformDirtyFlags': 0,
            'g_matrixStackTop': 0x2e5000}),
        ('count zero', {'g_currentNodeIdx': 0x2e4000,
            'g_eventQueueTotal': 0x2e4400, 'g_eventQueueEnd': 0,
            'g_xformEntityIdx': 0, 'g_pendingNodeType': 0x21,
            'g_framePauseFlag': 0, 'g_xformDirtyFlags': 0,
            'g_matrixStackTop': 0x2e5000}),
    ],
    # The eight-slot bracket ScenePostInitSequencer wraps its build in.
    'MStackPush8': [
        ('pushes the eight', {'g_matrixStackTop': 0x2e5000,
            'g_currentNodeIdx': 0x11, 'g_xformEntityIdx': 0x22,
            'g_pendingNodeType': 0x33, 'g_eventQueueTotal': 0x44,
            'g_eventQueueEnd': 0x55, 'g_iatPtr_00542058': 0x66,
            'g_fightGroupHead': 0x77, 'g_baseSel': 0x88}),
    ],
    'MStackPop8': [
        ('pops the eight', {'g_matrixStackTop': 0x2e5008,
            '@0xb94000': 0x11, '@0xb94004': 0x22, '@0xb94008': 0x33,
            '@0xb9400c': 0x44, '@0xb94010': 0x55, '@0xb94014': 0x66,
            '@0xb94018': 0x77, '@0xb9401c': 0x88,
            'g_currentNodeIdx': 0, 'g_xformEntityIdx': 0,
            'g_pendingNodeType': 0, 'g_eventQueueTotal': 0,
            'g_eventQueueEnd': 0, 'g_iatPtr_00542058': 0,
            'g_fightGroupHead': 0, 'g_baseSel': 0}),
    ],
    'TwinLoopSlotFinder': [
        ('first slot already good', {'g_matrixStackTop': 0x2e5000,
            'g_dispatchArg': 0x99, 'g_walkCallback': 0,
            'g_iatPtr_00542058': 0, '@0x4e2948': 0x2e4000}),
        ('skips two empties', {'g_matrixStackTop': 0x2e5000,
            'g_dispatchArg': 0x99, 'g_walkCallback': 0,
            'g_iatPtr_00542058': 0, '@0x4e2948': 0, '@0x4e2988': 0,
            '@0x4e29c8': 0x2e4000}),
        ('starts at walk value 2', {'g_matrixStackTop': 0x2e5000,
            'g_dispatchArg': 0x99, 'g_walkCallback': 2,
            'g_iatPtr_00542058': 0, '@0x4e2948': 0x1111,
            '@0x4e29c8': 0x2222}),
        ('negative wraps to the base', {'g_matrixStackTop': 0x2e5000,
            'g_dispatchArg': 0x99, 'g_walkCallback': 1,
            'g_iatPtr_00542058': 0, '@0x4e2948': 0x3333,
            '@0x4e2988': 0x80000001}),
    ],
    'TableSearch': [
