...
void Eleven404b90_404c00(void) {
    ...
    ((void (*)(unsigned int))ScaledPushArg_00404b90)(g_chainAccumCur);
    ((void (*)(unsigned int))ScaledPushArg_00404b90)(g_eventQueueNotMask);
    ((void (*)(unsigned int))ScaledPushArg_00404b90)(g_eventQueueChild);
