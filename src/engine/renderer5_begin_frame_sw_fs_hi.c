 ...
 *   *arg3 = 0x280; *arg2 = g_dispatchSave1624; *arg4 = 0; g_renderer4_surface = 1;
 *   if (arg1 && g_dispatchSave1624): memset(g_dispatchSave1624, 0x10001, *arg3 * 60 / 4).
 *   Return 1.
 */
...
__declspec(naked) int Renderer5_BeginFrame_SW_FS_Hi(void) {
    __asm {
        ...
        mov     esi, dword ptr [g_dispatchSave1624]
        ...
        _emit   74h
        _emit   2ch
        mov     ecx, dword ptr [g_dispatchSave1624]
        test    ecx, ecx
        _emit   74h
        _emit   22h
        ...
        cld
        mov     edi, dword ptr [g_dispatchSave1624]
