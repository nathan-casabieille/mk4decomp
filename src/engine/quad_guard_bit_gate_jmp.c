...
/* @addr 0x00439130 (90b)
 *   4-call cascade: call MStackPush3CmpCall; if pause: ret;
 *   if (bit0 of g_xformDirtyFlags)!=0: jmp SetJmp_StateDispatchYield_00438f60;
 *   call Wrapper_IterLoad_0048fd30_004f12a0; if pause: ret;
