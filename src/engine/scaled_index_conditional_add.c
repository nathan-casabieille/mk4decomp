 ...
 *   pause → ret; load lit 0xf; push OFFSET g_dispatchSave1305_004ed4e0;
 *   set walk and g_phaseTimer_00537e94 = 0xf; call F2; add esp, 4; ret.
 */
...
void GuardedSetCallSetCall_0047dee0(void) {
    ...
    g_phaseTimer_00537e94 = 0x0f;
    ArgSarStoreJmp_004594f0(&g_dispatchSave1305_004ed4e0);
}
