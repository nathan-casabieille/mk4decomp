...
extern void Wrapper_ArgSarStoreJmp_004eeeb0(void);
 ...
 *   eax = chain[sel].slot30; walkCallback=eax; if eax != 0: jmp Wrapper_ArgSarStoreJmp_004eeeb0.
...
void GatedChainClamp(void) {
    ...
    if (v != 0) {
        Wrapper_ArgSarStoreJmp_004eeeb0();
        return;
    }
