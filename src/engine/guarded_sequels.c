...
__declspec(naked) void GuardedSeq_004200b0(void) {
    __asm {
        call    ZeroTriple_00421c20
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
        jmp     PendingMatch_00401b70
        ret
    }
}
...
__declspec(naked) void GuardedSeq_004335d0(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     FiveTableInitChainBracketed_004774f0
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00433bb0(void) {
    __asm {
        call    PackedSelectLoad6_00433c60
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
        jmp     GuardedSeq_00433bd0
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00433bd0(void) {
    __asm {
        call    CmpP1DualInitStore_00433d30
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
        jmp     ScaledIndirectJmp_00433bf0
        ret
    }
}
...
__declspec(naked) void GuardedSeq_0044ba10(void) {
    __asm {
        call    ScaledLoadTwoCallDualConst_0044ba30
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
...
__declspec(naked) void GuardedSeq_004515a0(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     DualScaledLoadStoreJmp_00475790
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00453780(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     PoseCopyIdleCluster_004537a0
        ret
    }
}
...
__declspec(naked) void GuardedSeq_004605b0(void) {
    __asm {
        call    MStackNegAwareMul10Pair_004910b0
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
        jmp     ChainTableWalkStore_004917e0
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00467c10(void) {
    __asm {
        call    ScaledLoadTwoCallDualConst_00467c30
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
...
__declspec(naked) void GuardedSeq_00467c80(void) {
    __asm {
        call    GuardedTripleCallSetTail_00467ca0
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
...
__declspec(naked) void GuardedSeq_00472820(void) {
    __asm {
        call    DualPushCmp12Dispatch68_00474de0
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
        jmp     ByteWordTableTaggedDispatch_0048a050
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00472840(void) {
    __asm {
        call    DualPushCmp12Dispatch_00474d40
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
...
__declspec(naked) void GuardedSeq_00473ef0(void) {
    __asm {
        call    DualSetShiftCall_00473f90
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   75h
        _emit   05h
        jmp     DoubleStackPushAndJmp7b_00474090
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00473f10(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     DoubleStackPushAndJmp7d_00474050
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00473f30(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     DoubleStackPushAndJmp_00474010
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00473f50(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     DualPushSet7dCallPop_00474290
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00473f70(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     MStackPush2CjMul10Triple_00474170
        ret
    }
}
...
__declspec(naked) void GuardedSeq_00476f10(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     ChainSlotSetupInstallSelf_00476f30
        ret
    }
}
...
__declspec(naked) void GuardedSeq_0047d980(void) {
    __asm {
        ...
        _emit   75h
        _emit   05h
        jmp     MoveSelectorCluster_0047d9a0
        ret
    }
}
