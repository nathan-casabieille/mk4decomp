 ...
 *   eax = g_matrixStackTop; g_eventQueueCurrent = 4;
 *   ++eax; g_matrixStackTop = eax; [eax*4] = 4;
 *   call FlagCascadeStateSet_0048ec30; if pause: ret;
 *   ecx = g_matrixStackTop; eax = [ecx*4]; --ecx;
 *   g_matrixStackTop = ecx; cl = byte [g_xformDirtyFlags];
...
void PushFourCallPopBitJmp_00461020(void) {
    ...
    g_matrixStackTop++;
    *(unsigned int *)(g_matrixStackTop * 4) = 4;
    FlagCascadeStateSet_0048ec30();
    if (g_framePauseFlag != 0) return;
    v = *(unsigned int *)(g_matrixStackTop * 4);
    g_matrixStackTop--;
