 ...
 *   g_data_00542084 > 0x3333 tail-jmp SfxBlockCluster_00485a80; else call
...
void ChainedEvent3_00485a10(void) {
    ...
    *(unsigned int *)(g_baseSel_00542060 * 4 + 0x74) = v;
    ...
    if ((int)g_data_00542084 > 0x3333) {
        SfxBlockCluster_00485a80();
        return;
    }
    ScaledMove48to58_00490720();
    if (g_framePauseFlag != 0) return;
    IterStepDualStore_00490b40(0x004eeab4);
    if (g_framePauseFlag != 0) return;
    ArgSarStoreJmp_004594f0(0x004eeab8);
}
