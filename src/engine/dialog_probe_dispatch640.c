...
void DialogProbeDispatch640_004b0670(void) {
    ...
    int width;
    int height;
    if (g_x_0058c908 == 0) return;
    setStyle = (void (__stdcall *)(unsigned int, int, unsigned int))g_iat_004d21a0;
    setStyle(g_x_0058c8fc, -0x14, 8);
    setStyle(g_x_0058c8fc, -0x10, 0x90000000);
    ...
    ((void (__stdcall *)(unsigned int, int, int, int, int, int, int))g_iat_004d2190)(g_x_0058c8fc, 0, 0, 0, height, width, 0x44);
}
