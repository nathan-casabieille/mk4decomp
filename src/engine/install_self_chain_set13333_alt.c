...
void InstallSelfChainSet13333Alt(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  if (iVar2 != 0) {
    SetJmp_StateDispatchYield_00438f50();
    return;
  }
  LeaPlus22StoreSelf();
  if (g_framePauseFlag == 0) {
    ...
    *(code **)(iVar1 + 8) = InstallSelfChainSet13333Alt;
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 1;
    (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(int *)(iVar1 + 4);
    *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x14377d0;
