 ...
 *      install self with [esi+0x84]=2; g_pendingNodeType=0x28; g_framePauseFlag=1.
...
void InstallSelf3WayState(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  if (iVar2 == 0) {
    *(code **)(iVar1 + 8) = InstallSelf3WayState;
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 1;
    (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(int *)(iVar1 + 4);
    *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x1481f30;
