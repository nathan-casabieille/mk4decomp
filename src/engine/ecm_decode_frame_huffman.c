...
__declspec(naked) void ECM_DecodeFrame_Huffman(void)
{
    ...
    L_19da:
        je       L_1b68
        mov      al, byte ptr [ebx + g_dispatchSave832]
        xor      esi, esi
        test     al, al
        je       L_1a43
        and      eax, 0xff
    ...
    L_1a43:
        xor      ecx, ecx
        cmp      ebp, 0xf
        mov      cl, byte ptr [ebx + g_dispatchSave831]
        lea      eax, [ecx + esi + 3]
        mov      dword ptr [esp + 0x10], eax
        jge      L_1a62
        mov      eax, edi
    ...
    L_1ac4:
        shr      ebx, 7
        xor      eax, eax
        mov      cl, byte ptr [ebx + g_dispatchSave834]
        test     cl, cl
        je       L_1b28
        movsx    esi, cl
        sub      ebp, esi
    ...
    L_1b28:
        ...
        xor      ecx, ecx
        mov      cx, word ptr [ebx*2 + g_dispatchSave833]
        add      ecx, eax
        mov      eax, esi
        sub      eax, ecx
        dec      eax
