 ...
 *   if ecx != 0: call GuardedDualConst2AndToggle; if pause: ret;
 *     if (bit0 of g_xformDirtyFlags) == 0: jmp CallPauseDirty1JmpDirty4StackPush;
 *     else: jmp CallPauseScaledStorePushCall;
...
void InstallSelfCallBitGate(void) {
    ...
    *(unsigned int *)(base + 8) = MK4_CODE_VA(InstallSelfCallBitGate);
