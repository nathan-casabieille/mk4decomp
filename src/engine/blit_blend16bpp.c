...
__declspec(naked) void FlushDrawQueue(void)
{
    __asm {
        ...
        rep stosd
        jle      L_f4be
        mov      ecx, OFFSET g_data_00f71322
        mov      edx, esi
    L_f4ab:
        xor      eax, eax
        mov      ax, word ptr [ecx]
        ...
        jne      L_f4ab
    L_f4be:
        mov      eax, OFFSET g_data_00f6d052
    L_f4c3:
        mov      cx, word ptr [eax - 2]
        add      word ptr [eax], cx
        add      eax, 2
        cmp      eax, OFFSET g_data_00f6e050
        jl       L_f4c3
        lea      eax, [esi - 1]
        cmp      eax, ebx
        jl       L_f516
    ...
    L_f516:
        ...
        xor      edi, edi
    L_f528:
        cmp      byte ptr [esi + g_data_00f6e058], bl
        je       L_f547
        ...
        add      esp, 8
        mov      byte ptr [esi + g_data_00f6e058], bl
    L_f547:
        add      edi, 0x20000
        inc      esi
        cmp      edi, 0x200000
    ...
    L_f573:
        ...
        mov      dword ptr [g_data_00f70fb0], edx
        mov      cl, byte ptr [eax + 0x10]
        mov      dword ptr [g_data_00f70f88], ecx
        xor      ecx, ecx
    ...
    L_f5b8:
        ...
        mov      cl, byte ptr [eax + 0x10]
    L_f5db:
        mov      dword ptr [g_data_00f70f90], ecx
        mov      cx, word ptr [eax + 2]
        mov      dx, word ptr [eax + 0xa]
        cmp      cx, dx
        jle      L_f613
        movsx    ecx, dx
        mov      dword ptr [g_data_00f70fb8], ecx
        movsx    edx, word ptr [eax + 2]
        mov      dword ptr [g_data_00f70fc0], edx
        xor      edx, edx
    ...
    L_f636:
        fild     dword ptr [g_data_00f70fb0]
        mov      dword ptr [g_data_00f70fa0], ebx
        mov      cx, word ptr [eax + 0x14]
        push     ecx
        push     ebx
        fstp     dword ptr [esp + 0x20]
        fild     dword ptr [g_data_00f70fb8]
        mov      bl, byte ptr [g_data_00f70f90]
        mov      esi, dword ptr [esp + 0x20]
        push     ebx
        push     ecx
        fstp     dword ptr [esp + 0x2c]
        fild     dword ptr [g_data_00f70fc0]
        ...
        push     esi
        push     ecx
        mov      cl, byte ptr [g_data_00f70f88]
        push     edx
        mov      dx, word ptr [eax + 0x1a]
        push     ecx
        fild     dword ptr [g_data_00f70fa8]
        shr      edx, 7
        and      edx, 3
        push     edi
        push     ecx
        ...
        fild     dword ptr [g_data_00f70fc0]
        mov      eax, dword ptr [ebp]
        mov      dl, byte ptr [g_data_00f70fa0]
        add      esp, 0x44
        mov      bl, dl
        ...
        push     ecx
        push     ebx
        mov      bl, byte ptr [g_data_00f70f88]
        fstp     dword ptr [esp + 0x20]
        ...
        push     ecx
        push     edx
        mov      dl, byte ptr [g_data_00f70f90]
        push     edx
        push     esi
        push     ecx
        mov      dl, bl
        fstp     dword ptr [esp]
        push     ecx
        mov      cl, byte ptr [g_data_00f70f98]
        fild     dword ptr [g_data_00f70fb8]
        push     ecx
        push     edx
        push     ecx
    ...
    L_fc70:
        ...
        mov      dword ptr [g_data_00f70fb8], eax
        xor      eax, eax
        mov      al, byte ptr [ecx + 0xc]
        mov      dword ptr [g_data_00f70f88], eax
        xor      eax, eax
    ...
    L_fcda:
        ...
        mov      dword ptr [g_data_00f70fc0], esi
        movsx    ecx, word ptr [eax + 8]
        mov      dword ptr [g_data_00f70fac], ecx
        movsx    ecx, word ptr [eax + 0xa]
        mov      dword ptr [g_data_00f70fbc], ecx
        xor      ecx, ecx
        mov      cl, byte ptr [eax + 0xe]
        mov      edi, ecx
        xor      ecx, ecx
        mov      dword ptr [g_data_00f70f90], edi
        mov      cl, byte ptr [eax + 0xf]
        mov      dword ptr [g_data_00f70fa0], ecx
        xor      ecx, ecx
        mov      cl, byte ptr [eax + 0x10]
        mov      dword ptr [g_data_00f70f8c], ecx
        xor      ecx, ecx
        mov      cl, byte ptr [eax + 0x11]
        mov      dword ptr [g_data_00f70f9c], ecx
        xor      ecx, ecx
        mov      cx, word ptr [eax + 0x16]
        mov      ebp, ecx
        mov      ebx, ecx
    ...
    L_fda3:
        movsx    edx, word ptr [eax + 4]
        mov      dword ptr [g_data_00f70fac], edx
    ...
    L_fe4f:
        ...
        and      ecx, 0xf
        mov      dword ptr [g_data_00f85b4c], ecx
        mov      cx, word ptr [eax + 0x1a]
        mov      bl, cl
        shr      bl, 5
        test     bl, 1
    ...
    L_fea1:
        ...
        mov      dword ptr [g_data_00f70fc0], esi
        mov      dword ptr [g_data_00f70fb8], ecx
        mov      ecx, dword ptr [g_data_00f70f98]
        xor      ecx, edx
        xor      edx, ecx
        xor      ecx, edx
        mov      dword ptr [g_data_00f70fa0], edx
        mov      dword ptr [g_data_00f70f98], ecx
    L_fedb:
    ...
    L_019e:
        ...
        jne      L_01ee
        mov      ebx, dword ptr [g_data_00f70fac]
        mov      ebp, dword ptr [g_data_00f70fa8]
        mov      ecx, dword ptr [g_data_00f70fb8]
        sar      ebx, 1
        mov      dword ptr [g_data_00f70fac], ebx
        ...
        sar      edx, 1
        sar      esi, 1
        mov      dword ptr [g_data_00f70fa8], ebp
        mov      dword ptr [g_data_00f70fb8], ecx
        mov      dword ptr [g_data_00f70fbc], ebx
        mov      dword ptr [g_data_00f70fb0], edx
        mov      dword ptr [g_data_00f70fc0], esi
        jmp      L_01fa
    L_01ee:
    ...
    L_01fa:
        ...
        and      ebx, 0xf
        mov      dword ptr [g_data_00f85b4c], ebx
