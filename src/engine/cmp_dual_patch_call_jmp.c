 ...
 *   skip2: cmp eax,0xd; if eq: call Wrapper_ScaledChainPushCall_004ef8b0;
 *                         if pause: ret; else jmp Wrapper_ScaledChainPushCall_004ef858;
...
void CmpDualPatchCallJmp(void) {
    ...
    Wrapper_ScaledChainPushCall_004ef858();
}
