 ...
 *   ecx = [ecx*4+0x5c]; push eax, eax; g_eventQueueCurrent = ecx;
 *   call Mul10Tail; pop esp; g_walkCallback = ret;
 *   eax = g_eventQueueCurrent; push eax, eax;
...
void DualMul10AccCj(void) {
    ...
    r2 = ((unsigned int (*)(unsigned int, unsigned int))Mul10Tail)(v2, v2);
    g_eventQueueCurrent = r2;
    g_walkCallback = (void (*)(void))(r1 + r2);
}
