 ...
 *   g_cj_0054205c = g_eventQueueEnd; call MStackPush2RunCountdown_004089e0; if pause: ret;
 *   g_walkCallback = 7; call ChainDirtyBitWalker_00408c10; if pause: ret;
 *   [g_xformEntityIdx*4] |= 4; ecx=g_xformEntityIdx;
 *   eax=0xa0000; g_walkCallback=eax; [ecx*4+0x34]=eax;
 *   call MStackBracket7_DispatchAndChain_004b8fa0; if pause: ret;
