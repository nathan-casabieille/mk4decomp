...
#define g_dispatchSave1620 (*(unsigned int *)MK4_VA(unsigned int, 0x7af934u))
#define g_dispatchSave1621 (*(unsigned int *)MK4_VA(unsigned int, 0x7af938u))
#define g_dispatchSave1622 (*(unsigned int *)MK4_VA(unsigned int, 0x7af93cu))
#define g_dispatchSave1623 (*(unsigned int *)MK4_VA(unsigned int, 0x7af944u))
#define g_dispatchSave1625 (*(unsigned int *)MK4_VA(unsigned int, 0x7af950u))
...
#define g_iat_DeleteObject (*(unsigned int *)MK4_VA(unsigned int, 0x4d2030u))
#define g_iat_InvalidateRect (*(unsigned int *)MK4_VA(unsigned int, 0x4d2210u))
#define g_iat_ReleaseDC (*(unsigned int *)MK4_VA(unsigned int, 0x4d21a8u))
#define g_installOwnerNode (*(unsigned int *)MK4_VA(unsigned int, 0x535cf8u))
#define g_lastGatedTick (*(unsigned int *)MK4_VA(unsigned int, 0x54358cu))
#define g_lastGatedValue (*(unsigned int *)MK4_VA(unsigned int, 0x543598u))
#define g_rangeBase (*(unsigned int *)MK4_VA(unsigned int, 0x53a46cu))
#define g_rangeSqLimit (*(unsigned int *)MK4_VA(unsigned int, 0x53a180u))
#define g_renderer4_active (*(int *)MK4_VA(int, 0x7af940u))
