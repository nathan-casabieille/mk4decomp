 ...
 *   call MStackFrameCdeclDouble_004903f0; if pause: ret;
 *   call ChainTableWalkStore_004917e0; if pause: ret;
...
void Push80SetWalkDualCallPop_00439350(void) {
    ...
    *(unsigned int *)(top * 4) = g_state_00542080;
    g_walkCallback = (void (*)(void))0xf5c;
    MStackFrameCdeclDouble_004903f0();
    if (g_framePauseFlag != 0) return;
    ChainTableWalkStore_004917e0();
    if (g_framePauseFlag != 0) return;
    top = g_state_004d57ac;
    g_state_00542080 = *(unsigned int *)(top * 4);
