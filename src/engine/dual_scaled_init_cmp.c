...
void DualScaledInitCmp_0046dbd0(void) {
    ...
    g_scaledInit_00542044 = (unsigned int)&g_installCountdownSlot >> 2;
...
void DualScaledInitCmp_0046df50(void) {
    g_pendingNodeType = g_player1NodeIdx;
    g_scaledInit_00542044 = (unsigned int)&g_dispatchSave13 >> 2;
    g_scaledInit_00542048 = (unsigned int)&g_phaseThunkSlot3 >> 2;
    if (g_fightGroupHead != g_player1NodeIdx) {
        g_scaledInit_00542044 = (unsigned int)&g_phaseThunkSlot3 >> 2;
    }
}
