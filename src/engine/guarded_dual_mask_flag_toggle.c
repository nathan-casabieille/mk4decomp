...
/* @addr 0x004261d0 (82b)
 *   call MStackPush2TableNot_00426230; if pause: ret;
 *   g_walkCallback &= 0x7070; g_eventQueueWorkType = 0xffff;
 *   if walkCallback != 0: set bit0 of g_xformDirtyFlags, ret;
 *   else g_eventQueueCurrent &= 0x77;
 *   if zero: clear bit0 of g_xformDirtyFlags, ret;
