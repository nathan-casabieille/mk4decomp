...

{
  ...
  iVar4 = g_dispatchSave1361;
  iVar1 = g_dispatchSave1362;
  if (g_viewportX != 0) {
    iVar13 = g_dispatchSave1383 - g_dispatchSave1381;
    iVar7 = g_dispatchSave1382 - g_dispatchSave1381;
    g_clipMinScratch = (g_dispatchSave1379 - g_dispatchSave1378) * iVar13 - (g_dispatchSave1380 - g_dispatchSave1378) * iVar7;
    if (0 < (int)g_clipMinScratch) {
      uVar11 = (g_dispatchSave1372 - g_dispatchSave1371) * iVar13 - (g_dispatchSave1373 - g_dispatchSave1371) * iVar7;
      if ((int)((uVar11 ^ (int)uVar11 >> 0x1f) - ((int)uVar11 >> 0x1f)) < 0x80000) {
        g_dispatchSave1342 = (int)(uVar11 * 0x1000) / (int)g_clipMinScratch << 4;
      }
      else {
        g_dispatchSave1342 = (int)(uVar11 * 0x200) / (int)g_clipMinScratch << 7;
      }
      uVar11 = (g_dispatchSave1376 - g_dispatchSave1374) * iVar13 - (g_dispatchSave1377 - g_dispatchSave1374) * iVar7;
      if ((int)((uVar11 ^ (int)uVar11 >> 0x1f) - ((int)uVar11 >> 0x1f)) < 0x80000) {
        g_dispatchSave1343 = (int)(uVar11 * 0x1000) / (int)g_clipMinScratch << 4;
      }
      else {
        g_dispatchSave1343 = (int)(uVar11 * 0x200) / (int)g_clipMinScratch << 7;
      }
      g_dispatchSave1394 = g_dispatchSave1381;
      bVar15 = g_dispatchSave1381 <= g_dispatchSave1382;
      g_dispatchSave1365 = g_dispatchSave1382;
      if (bVar15) {
        g_dispatchSave1394 = g_dispatchSave1382;
        g_dispatchSave1365 = g_dispatchSave1381;
      }
      g_dispatchSave1359 = (uint)!bVar15;
      g_dispatchSave1366 = (uint)!bVar15;
      ...
      if (g_dispatchSave1365 < g_dispatchSave1394) {
        do {
          while (g_dispatchSave1364 <= g_dispatchSave1365) {
            ...
            g_dispatchSave1364 = (&g_dispatchSave1381)[uVar12];
            iVar4 = g_dispatchSave1364 - (&g_dispatchSave1381)[uVar11];
            uVar5 = uVar11;
            if (iVar4 != 0) {
              g_dispatchSave1338 = (((&g_dispatchSave1378)[uVar12] - (&g_dispatchSave1378)[uVar11]) * 0x10000) / iVar4
              ;
              g_dispatchSave1336 = (((&g_dispatchSave1371)[uVar12] - (&g_dispatchSave1371)[g_dispatchSave1359]) * 0x10000) /
                             iVar4;
              g_dispatchSave1337 = (((&g_dispatchSave1374)[uVar12] - (&g_dispatchSave1374)[g_dispatchSave1359]) * 0x10000) /
                             iVar4;
              uVar5 = g_dispatchSave1359;
            }
            g_dispatchSave1363 = (&g_dispatchSave1378)[uVar5] * 0x10000;
            g_dispatchSave1361 = (&g_dispatchSave1371)[uVar5] * 0x10000;
            g_dispatchSave1362 = (&g_dispatchSave1374)[uVar5] * 0x10000;
            g_clipMaxScratch = g_dispatchSave1365 - (&g_dispatchSave1381)[uVar11];
            uVar11 = uVar12;
            g_dispatchSave1359 = uVar12;
            iVar4 = g_dispatchSave1361;
            iVar1 = g_dispatchSave1362;
          ...
          for (; g_dispatchSave1404 = iVar7, 0 < g_dispatchSave1393; g_dispatchSave1393 = g_dispatchSave1393 + -1) {
            ...
            if (((0 < g_clipMaxScratch) && (-1 < g_dispatchSave1370)) && ((int)g_clipMinScratch < g_viewportW))
            {
              ...
              psVar14 = (short *)(g_dispatchSave1346 + g_clipMinScratch * 2);
              if (g_viewportW < g_clipMaxScratch) {
                g_clipMaxScratch = g_viewportW;
              }
              g_clipMinScratch = g_clipMaxScratch - g_clipMinScratch;
              g_dispatchSave1345 = psVar14;
              if (0 < (int)g_clipMinScratch) {
                cVar3 = (char)((uint)g_dispatchSave1343 >> 0x10);
                cVar6 = (char)((uint)g_dispatchSave1342 >> 0x10);
                uVar5 = CONCAT22((short)g_dispatchSave1342,CONCAT11(cVar3,cVar6));
                uVar11 = g_dispatchSave1389 << 0x10;
                uVar12 = CONCAT21((short)((uint)g_dispatchSave1389 >> 0x10),
                                  (char)((uint)g_dispatchSave1387 >> 0x10)) & 0xffff;
                uVar10 = CONCAT22((short)g_dispatchSave1343,(short)g_clipMinScratch);
                iVar13 = g_dispatchSave1387 << 0x10;
                g_dispatchSave1361 = iVar4;
                g_dispatchSave1362 = iVar1;
                do {
                  sVar8 = *(short *)(iVar7 + uVar12 * 2);
                  uVar2 = CONCAT22((short)((uint)iVar13 >> 0x10),sVar8);
                  if (sVar8 != 0) {
                    *psVar14 = sVar8;
                  }
                  bVar15 = CARRY4(uVar11,uVar10);
                  uVar11 = uVar11 + uVar10;
                  iVar13 = uVar2 + uVar5;
                  uVar12 = (uint)CONCAT11((char)(uVar12 >> 8) + cVar3 + bVar15,
                                          (char)uVar12 + cVar6 + CARRY4(uVar2,uVar5));
                  psVar14 = psVar14 + 1;
                  sVar9 = (short)uVar10;
                  sVar8 = sVar9 + -1;
                  uVar10 = CONCAT22((short)(uVar10 >> 0x10),sVar8);
                } while (sVar8 != 0 && 0 < sVar9);
              }
            }
