...
extern void (__stdcall *g_iat_SetDIBitsToDevice)(unsigned int, int, int, int, int, int, int, int, int, unsigned int, unsigned int, int);
extern void (__stdcall *g_iat_GdiFlush)(void);
...
void Renderer4_PresentFrame(void) {
    ...
    g_iat_SetDIBitsToDevice(g_dispatchSave1621_007af938, 0, 0, 0x140, 0xf0, 0, 0, 0, 0xf0, g_dispatchSave1624_007af94c, g_dispatchSave1620_007af934, 0);
    g_iat_GdiFlush();
}
