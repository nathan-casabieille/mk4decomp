...
void ScaledAndAhdf_00490330(void) {
    ...
    unsigned int v = ((FightGroupNode *)MK4_PTR((idx * 4)))->bits & 0xFFFFFFDFu;
    g_eventQueueCurrent = v;
    ((FightGroupNode *)MK4_PTR((idx * 4)))->bits = v;
}

/* @addr 0x00490350 (28b): scaled and ah, 0xbf */
void ScaledAndAhbf_00490350(void) {
    unsigned int idx = g_fightGroupHead;
    unsigned int v = ((FightGroupNode *)MK4_PTR((idx * 4)))->bits & 0xFFFFFFBFu;
    g_eventQueueCurrent = v;
    ((FightGroupNode *)MK4_PTR((idx * 4)))->bits = v;
}
...
void ScaledAndAhfb_00490370(void) {
    unsigned int idx = g_fightGroupHead;
    unsigned int v = ((FightGroupNode *)MK4_PTR((idx * 4)))->bits & 0xFFFFFFFBu;
    g_eventQueueCurrent = v;
    ((FightGroupNode *)MK4_PTR((idx * 4)))->bits = v;
}
...
void ScaledAndAhfe_00490390(void) {
    unsigned int idx = g_fightGroupHead;
    unsigned int v = ((FightGroupNode *)MK4_PTR((idx * 4)))->bits & 0xFFFFFFFEu;
    g_eventQueueCurrent = v;
    ((FightGroupNode *)MK4_PTR((idx * 4)))->bits = v;
}
