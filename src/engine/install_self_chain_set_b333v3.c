...
void InstallSelfChainSetB333v3(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  ...
  if (g_framePauseFlag == 0) {
    ...
    *(code **)(iVar1 + 8) = InstallSelfChainSetB333v3;
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 1;
    (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(int *)(iVar1 + 4);
    *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x1437fb0;
...
__declspec(naked) void InstallSelfChainSetB333v3(void) {
    __asm {
        ...
        _emit   75h
        _emit   73h
        mov     dword ptr [g_currentNodeFlags], 0x0000b333
