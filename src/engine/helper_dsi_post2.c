 ...
 *   return 0; else preserve prior g_dispatchSave1410_00f9eb74; build WAVEFORMATEX
...
extern unsigned int g_dispatchSave1410_00f9eb74;
extern unsigned int g_dispatchSave1411_00f9eb78;
...
__declspec(naked) void Helper_DSI_post2(void) {
    __asm {
        ...
        test    eax, eax
        je      doneRet
        mov     esi, dword ptr [g_dispatchSave1410_00f9eb74]
        xor     ecx, ecx
        mov     dword ptr [g_word_00f9eb70], ecx
        mov     word ptr [g_word_00f9eb70], 1
        mov     dword ptr [g_dispatchSave1410_00f9eb74], ecx
        mov     word ptr [g_word_00f9eb72], 2
        mov     dword ptr [g_dispatchSave1411_00f9eb78], ecx
        ...
        mov     dword ptr [g_dispatchSave1411_00f9eb78], edx
