 ...
 *   if ecx != 0: jmp InstallSelfFullPath_0047a840;
 *   edx = g_state_00542088; ecx = 1; if edx==1: jmp InstallSelfCountdownChain_0047a950;
...
void InstallSelfOrChainCmpJmp_0047a8f0(void) {
    unsigned char *base = (unsigned char *)(g_baseSel_00542060 * 4);
    unsigned int v = *(unsigned int *)(base + 0x84);
    *(unsigned int *)(base + 0x84) = 0;
    if (v != 0) {
        InstallSelfFullPath_0047a840();
        return;
    }
    if (g_state_00542088 == 1) {
        InstallSelfCountdownChain_0047a950();
        return;
    }
    *(unsigned int *)(base + 8) = (unsigned int)&InstallSelfOrChainCmpJmp_0047a8f0;
