...

{
  ...
  *(undefined4 *)(iVar2 + 0x84) = 0;
  ...
  case 0:
    ...
    *MK4_NODE(undefined4, (g_currentNodeIdx)) = 0x1484480;
  ...
  case 1:
    *(code **)(iVar2 + 8) = GameStateLinearAdvance4Way;
    ...
    (g_currentNodeIdx) = *(int *)(iVar2 + 4);
    *MK4_NODE(undefined4, (g_currentNodeIdx)) = 0x2484480;
    (g_currentNodeIdx) = (g_currentNodeIdx) + 1;
    *(int *)(iVar2 + 4) = (g_currentNodeIdx);
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 0;
    RunFsmCluster();
  ...
  case 2:
    *(code **)(iVar2 + 8) = GameStateLinearAdvance4Way;
    ...
    (g_currentNodeIdx) = *(int *)(iVar2 + 4);
    *MK4_NODE(undefined4, (g_currentNodeIdx)) = 0x3484480;
    (g_currentNodeIdx) = (g_currentNodeIdx) + 1;
    *(int *)(iVar2 + 4) = (g_currentNodeIdx);
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 0;
    RunFsmCluster();
  ...
  case 3:
    *(code **)(iVar2 + 8) = GameStateLinearAdvance4Way;
    ...
    (g_currentNodeIdx) = *(int *)(iVar2 + 4);
    *MK4_NODE(undefined4, (g_currentNodeIdx)) = 0x4484480;
    (g_currentNodeIdx) = (g_currentNodeIdx) + 1;
    *(int *)(iVar2 + 4) = (g_currentNodeIdx);
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 0;
    RunFsmCluster();
