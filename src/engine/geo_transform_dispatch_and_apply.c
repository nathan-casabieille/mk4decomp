...
#define g_dispatchVar20 (*(unsigned int *)MK4_VA(unsigned int, 0x54200cu))
...
#define g_primary_0053a774 (*(unsigned int *)MK4_VA(unsigned int, 0x53a774u))
#define g_rangeBase (*(unsigned int *)MK4_VA(unsigned int, 0x53a46cu))
#define g_rangeSqLimit (*(unsigned int *)MK4_VA(unsigned int, 0x53a180u))
#define g_secondary_00535d04 (*(unsigned int *)MK4_VA(unsigned int, 0x535d04u))
...

{
  ...
  g_currentNodeFlags = g_secondary_00535d04;
...
__declspec(naked) void GeoTransformDispatchAndApply(void)
{
    ...
    L_9871:
        ...
        mov      dword ptr [g_walkCallback], eax
    L_9889:
        mov      edx, dword ptr [g_dispatchVar20]
        add      eax, edx
