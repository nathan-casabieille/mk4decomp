...
void InstallSelfChainSet80Call(void)

{
  ...
  *(undefined4 *)(iVar2 + 0x84) = 0;
  if (iVar1 != 0) {
    ChainDecCondStoreCallJmp();
    return;
  }
  g_eventQueueChild = 0x3c;
  *(code **)(iVar2 + 8) = InstallSelfChainSet80Call;
  MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 1;
  (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(int *)(iVar2 + 4);
  *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x14347f0;
...
#else
__declspec(naked) void InstallSelfChainSet80Call(void) {
    __asm {
