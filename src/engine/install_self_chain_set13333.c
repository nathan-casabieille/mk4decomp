...
void InstallSelfChainSet13333(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  ...
  if (g_framePauseFlag == 0) {
    g_currentNodeFlags = 0x13333;
    g_eventQueueChild = 0x1e;
    *(code **)(iVar1 + 8) = InstallSelfChainSet13333;
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 1;
    (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(int *)(iVar1 + 4);
    *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x1437880;
...
#else
__declspec(naked) void InstallSelfChainSet13333(void) {
    __asm {
        ...
        _emit   75h
        _emit   73h
        mov     dword ptr [g_currentNodeFlags], 0x00013333
