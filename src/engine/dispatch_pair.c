 ...
 *   TableWalkBoundedCmp(7); MStackPush8; pause? jmp MStackPop8.
 *   mstack-push walkCallback; TwinLoopSlotFinder; pause? jmp MStackPop8.
 *   scaledInit = arr[g_eventQueueIdx]; LoadGeoAsset_Default; pause? jmp MStackPop8.
 *   scaledInit = chain[g_eventQueueIdx].slot4; LoadGeoAsset_Default; pause? jmp MStackPop8.
...
#define g_chain_arr_4348f0 (*(unsigned int *)MK4_VA(unsigned int, 0x0u))
