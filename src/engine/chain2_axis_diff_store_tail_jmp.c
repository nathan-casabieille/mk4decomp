...
void Chain2AxisDiffStoreTailJmp(void) {
    ...
    g_walkCallback = a;
    b = ((ScenegraphNode *)(g_eventQueueIdx * 4))->position_x;
    a -= b;
    g_eventQueueCurrent = b;
    ((ScenegraphNode *)(g_baseSel * 4))->child_a = a;
    g_walkCallback = 0;
    ((ScenegraphNode *)(g_baseSel * 4))->child_b = 0;
    a = ((ScenegraphNode *)(g_eventQueueEnd * 4))->position_z;
    g_walkCallback = a;
    b = ((ScenegraphNode *)(g_eventQueueIdx * 4))->position_z;
    g_eventQueueCurrent = b;
    a -= b;
    g_walkCallback = a;
