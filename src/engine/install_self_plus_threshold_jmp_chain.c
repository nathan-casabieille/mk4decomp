 ...
 *     If bit0 of state set: tail-call PushCallPauseSet1Jmp; else
 *     tail-call CallPauseMStackPushSet2Jmp.
...
void InstallSelfPlusThresholdJmpChain(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0) {
      g_currentNodeFlags = 0xcccc;
      g_eventQueueChild = 0x1e;
      *(code **)(iVar1 + 8) = InstallSelfPlusThresholdJmpChain;
      MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 1;
      (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(int *)(iVar1 + 4);
      *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x14359f0;
...
#else
__declspec(naked) void InstallSelfPlusThresholdJmpChain(void) {
    __asm {
        ...
        _emit   75h
        _emit   07h
        call    PushCallPauseSet1Jmp
        pop     esi
        ret
        call    CallPauseMStackPushSet2Jmp
        pop     esi
        ret
