...
#endif
#ifdef NON_MATCHING
/* Same signatures its converted sibling tristrip_batch_emit.c uses. */
...
/* a WORD at 0x007af958, not a dword - it sits next to the projection scratch */
      ...
      do {
        ...
        if ((((uVar3 != (g_vtxValid == 0)) && (0 < (int)g_min_007af984)) && (0 < (int)g_min_007af988)) &&
          ...
          *(ushort *)((char *)puVar7 + 0x1a) =
          ...
          iVar5 = MaxOfThree();
          *(short *)((char *)puVar7 + 0x12) = (short)(iVar5 + 2000);
          *(short *)((char *)puVar7 + 0x12) = (short)(g_dispatchSave1559 * 0x20 + iVar5 + 2000);
          *(ushort *)((char *)puVar7 + 0x1a) =
