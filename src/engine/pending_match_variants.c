 ...
 *   push 0x23c and 0x00426da0 as args; call StoreTwoCall;
...
extern void ChainUnlinkPushFree(void);
...
extern void FsmPoseDualEntry(void);
...
extern void InstallSelfIndexWalk(void);
extern void InstallSelfMidPush(void);
...
extern void ScaledSaveCallRestoreJmp_InstallSelfMagicShift_then_MStackPush2ChainLLInsert_00472f80(void);
...
extern void CallPauseScaledByteSet(void);
extern void CallPauseScaledStoreCopyJmp(void);
...
extern void CjFieldCopyCascade(void);
extern void CjInstallSelfRouter(void);
...
extern void DoublePushScaledInitJmp(void);
...
extern void DualPushSet7bCallPop(void);
...
extern void FiveCallScaledChainTailJmp(void);
extern void FourConstCallLitCallJmp_Wrapper_IterLoad_0048fd30_then_TripleScaledChainStore_then_StageEventStartCluster_0047ff20(void);
extern void FourFieldCopyCallSet(void);
extern void GDispatch4(void);
extern void GameInstall2BodyMul10ScaledInit(void);
extern void GateDispatch6c(void);
extern void GatedWordPushCall(void);
extern void GuardedBitMaskFlagOrClear(void);
extern void GuardedChainCmpDualBitXor(void);
...
extern void GuardedScaled_TestP1ReplaceCurrent_then_LinkedListSearch_00475000(void);
...
extern void GuardedSeq_DualPushCmp12Dispatch68_then_ByteWordTableTaggedDispatch(void);
...
extern void InitStateDualCall48ac70(void);
extern void InitZeroSixFields(void);
...
extern void PushClampZeroOneCallPop(void);
extern void PushImmCallSetCallAdjustCall(void);
...
extern void SetWalk0xaCrossStore(void);
extern void SetWalkCurCallPauseDirty(void);
extern void SevenThunks(void);
extern void SlideAttackEventCluster(void);
extern void SlotPhaseResetInstallChain(void);
extern void SpecialInitDirtyJmp(void);
extern void StackPopDispatchTagged(void);
...
extern void TriCmpOrFinal(void);
extern void TripleBranchInstall(void);
extern void TripleSetCallPauseDirtyJmp(void);
extern void TripleSubVec3(void);
extern void TwinLoopSlotFinder(void);
extern void TwinMStackPushScaledChain(void);
extern void TwoCallJmp(void);
...
extern int  GuardedCallStoreSlotsCmp(void);

/* @addr 0x004431e0 (316b game) - mstack-push + 3-call chain + bit2-gate + nested mstack-push + last-call sequence.
 *   Push g_eventQueueEnd onto mstack. g_cj=g_eventQueueEnd. Load chain[g_eventQueueTotal*4]->g_walkCallback.
...
__declspec(naked) void StateMachineDualModuloInstall(void) {
    __asm {
        ...
        call    GuardedSeq_DualPushCmp12Dispatch68_then_ByteWordTableTaggedDispatch
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
        _emit   0fh
        _emit   85h
        ...
        ret
        mov     eax, 1
        mov     dword ptr [esi + 8], offset StateMachineDualModuloInstall
...
__declspec(naked) void FourPackedSubInitCmpDispatch(void)
{
    __asm
    {
        mov     eax, dword ptr [g_baseSel]
        ...
        mov     dword ptr [g_fightGroupHead], edx
        mov     dword ptr [g_eventQueueWorkType], 0x26b
        mov     dword ptr [g_pendingNodeType], 0x4678b0
        call    AllocNode
        mov     eax, dword ptr [g_framePauseFlag]
        test    eax, eax
...
__declspec(naked) void StageEventExitCluster(void)
{
    __asm {
        /* H1: stage-exit sound */
        push     OFFSET g_dispatchSave597
        call     ArgSarStoreJmp
        add      esp, 4
        ret
        nop
...
__declspec(naked) void IntroFsmCluster(void)
{
    ...
    L_d5c0:
        ...
        ret
    L_d61c:
        mov      edx, OFFSET g_dispatchTableArr5
        shr      edx, 2
        mov      dword ptr [g_eventQueueEnd], edx
...
__declspec(naked) void VersusScreenFsmCluster(void)
{
    __asm {
        /* === Helper 1 (0x44f670): tiny event 004e6f50 forwarder === */
    L_f670:
        push     OFFSET g_dispatchSave942
        call     ArgSarStoreJmp
        add      esp, 4
        ret
        nop
    ...
    L_f6b6:
        ...
        ret
    L_f6ca:
        push     OFFSET g_dispatchSave943
        call     ScaledIdxLoadCallTailThunk
        mov      eax, dword ptr [g_framePauseFlag]
        add      esp, 4
        test     eax, eax
        jne      short L_f74e
        mov      ecx, OFFSET g_dispatchSave151
        shr      ecx, 2
        mov      dword ptr [g_eventQueueEnd], ecx
...
/* + matrix + walker), each gated by g_framePauseFlag.                */
/* ------------------------------------------------------------------ */
...
/*                 4b8fa0) → tail-jmp GuardedSeq_DualSetShiftCall_then_DualPushSet7dCallPop.                  */
...
__declspec(naked) void ComboMoveSelectFsmCluster(void)
{
    __asm {
    ...
    L_a2f6:
        ...
        je       short L_a336
        xor      dword ptr [g_xformDirtyFlags], edx
    L_a336:
...
__declspec(naked) void EnduranceStateInitWalk(void)
{
    __asm {
        /* === h1 (0x4785a0): 16-iter list copy + timer install === */
        mov      eax, OFFSET g_dispatchSave734
    ...
    L_85be:
        ...
        mov      dword ptr [g_dispatchSave104], eax
        cmp      edx, eax
        mov      dword ptr [g_dispatchSave92], eax
        mov      dword ptr [g_dispatchSave103], eax
        mov      dword ptr [g_dispatchSave101], eax
        mov      ecx, 0x10000
        jne      short L_8638
        mov      dword ptr [g_clamp_0053a6dc], ecx
        mov      dword ptr [g_clamp_00537f2c], ecx
    L_8638:
        push     0x221
        push     OFFSET L_8670
        ...
        mov      dword ptr [g_walkCallbackSrc2], eax
    ...
    L_86af:
        mov      eax, 3
        mov      edi, OFFSET g_dispatchSave68
        mov      dword ptr [g_xformLoopCounter], eax
        shr      edi, 2
    L_86c1:
        mov      ecx, edi
...
__declspec(naked) void AerialHitDispatcher(void)
{
    __asm {
    ...
    L_c335:
        ...
        jmp      L_c290
    L_c361:
        cmp      dword ptr [g_xformScratch2088], eax
        jne      short L_c36e
        jmp      FourConstCallLitCallJmp_Wrapper_IterLoad_0048fd30_then_TripleScaledChainStore_then_StageEventStartCluster_0047ff20
    L_c36e:
        call     DualCallPauseDirtyJmp_00490c30
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      short L_c3b9
        mov      dword ptr [g_phaseTimer], 0x5a
        mov      dword ptr [g_walkCallback], 8
        call     ScaledLitLoadCall_ScaledChainCallPauseSetJmp_then_Wrapper_IterLoad_0048fd30_00481020
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      short L_c3b9
...
__declspec(naked) void BossPunchCluster(void)
{
    ...
    L_6cb2:
        ...
        lea      esi, [edx*4]
        mov      dword ptr [g_eventQueueCurrent], eax
        call     PushImmCallSetCallAdjustCall
        mov      ecx, dword ptr [g_eventQueueCurrent]
    ...
    L_6d60:
        ...
        jmp      dword ptr [eax*4 + L_jmptbl]
    L_6d8e:
        mov      dword ptr [g_walkCallback], 0x2f
        call     GatedWordPushCall
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_6fc5
        ...
        mov      dword ptr [g_eventQueueEnd], edx
        call     GuardedScaled_TestP1ReplaceCurrent_then_LinkedListSearch_00475000
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_6fc5
        test     byte ptr [g_xformDirtyFlags], 4
        je       L_6ea9
        mov      eax, OFFSET g_dispatchSave148
    ...
    L_6e83:
        ...
        jne      L_6fc5
    L_6ea9:
        mov      edx, OFFSET g_dispatchSave149
...
__declspec(naked) void BackdashSetupCluster(void)
{
    __asm {
        mov      eax, dword ptr [g_eventQueueEnd]
        mov      dword ptr [g_fightGroupHead], eax
    ...
    L_10a5:
        ...
        test     eax, eax
        jne      L_1196
        mov      edx, OFFSET g_dispatchSave150
    ...
    L_1126:
        ...
        jne      L_1196
        mov      eax, dword ptr [g_eventQueueIdx]
        mov      dword ptr [g_currentNodeFlags], 0x15999
        mov      dword ptr [g_fightGroupHead], eax
        call     GameInstall2BodyMul10ScaledInit
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
...
__declspec(naked) void JuggleSetupCluster(void)
{
    __asm {
        mov      dword ptr [eax*4], ecx
        mov      eax, dword ptr [g_currentNodeIdx]
    ...
    L_3a4e:
        ...
        test     eax, eax
        jne      L_3b3b
        mov      ecx, OFFSET g_dispatchSave147
        shr      ecx, 2
        mov      dword ptr [g_eventQueueEnd], ecx
    ...
    L_3ad0:
        ...
        mov      dword ptr [esi + 8], OFFSET L_3a10
        mov      dword ptr [esi + 0x84], eax
        mov      dword ptr [g_pendingNodeType], 0x1f
        mov      dword ptr [g_framePauseFlag], eax
    L_3b3b:
        pop      esi
        ret      
    ...
    L_3c50:
        ...
        jmp      L_3c9f
    L_3c95:
        mov      dword ptr [g_eventQueueEnd], 0x10
    L_3c9f:
        mov      dword ptr [g_walkCallback], 0x2bc
        call     AudioVolumeRescale
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_3e6d
    ...
    L_3da6:
        ...
        ret      
    L_3dae:
        push     OFFSET NetEntityScanAndPunish
        mov      dword ptr [g_eventQueueEnd], 0x32
        call     StoreLoadJmp
        add      esp, 4
    L_3dc5:
        mov      dword ptr [g_walkCallback], 0xfa
        call     AudioVolumeRescale
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_3e6d
...
__declspec(naked) void IntroSettingsFsmCluster(void)
{
    __asm {
        mov      ecx, dword ptr [g_baseSel]
        mov      eax, 0x108
    ...
    L_c20c_jmptbl:
        ...
        nop
        nop
        mov      dword ptr [g_eventQueueNotMask], 0x80002
        jmp      HitReactionDispatcher
        nop      
        mov      dword ptr [g_eventQueueNotMask], 0x80003
        jmp      HitReactionDispatcher
        nop      
        mov      dword ptr [g_eventQueueNotMask], 0x80000
        jmp      HitReactionDispatcher
        nop      
        mov      dword ptr [g_eventQueueNotMask], 0x80001
        jmp      HitReactionDispatcher
        nop      
        call     ScaledMove48to58
        mov      eax, dword ptr [g_framePauseFlag]
    ...
    L_c2e3:
        ...
        test     eax, eax
        je       L_c349
        call     InstallSelfMultiThunkDispatch
        pop      esi
        ret      
    L_c349:
        mov      dword ptr [g_walkCallback], 0x10
...
__declspec(naked) void PendingMatch_CallPauseScaledStoreCopyJmp(void)
{
    ...
    L_be60:
        ...
        mov      dword ptr [g_dispatchVar6], ecx
    L_be80:
        push     0x4e4e78
...
#ifdef NON_MATCHING
/* Ghidra-decompiled twin - behavior not yet runtime-verified */
void PendingMatch_QuadCallPhase2(void)
...
__declspec(naked) void PendingMatch_QuadCallPhase2(void)
{
    ...
    L_9540:
        ...
        mov      dword ptr [g_eventQueueWorkType], 0x1b58
        call     Push16Call
        mov      dword ptr [g_eventQueueWorkType], 0xd2
        call     Push16Call
        mov      dword ptr [g_eventQueueWorkType], 0xb9
        call     Push16Call
    ...
    L_95b8:
        ...
        cmp      dword ptr [g_framePauseFlag], edi
        jne      L_986a
        mov      dword ptr [g_walkCallback], 0x24d
        mov      dword ptr [g_eventQueueCurrent], 0x28f
        call     TwoPhaseInstallScaledPackedPtr
        pop      edi
        pop      esi
        ret      
    L_95f6:
    ...
    L_9654:
        ...
        mov      edx, dword ptr [g_gtPlayerProbe1]
        mov      dword ptr [g_player1NodeIdx], ecx
    ...
    L_96c1:
        ...
        mov      dword ptr [g_eventQueueTotal], eax
        mov      eax, dword ptr [g_baseSel]
        mov      dword ptr [g_player2NodeIdx], ecx
        mov      ecx, dword ptr [g_dlNalt4]
        mov      dword ptr [g_currentNodeIdx], edx
        mov      edx, dword ptr [g_player1NodeIdx]
        mov      dword ptr [g_walkCallbackSrc2], edi
    ...
    L_99be:
        ...
        call     CopyThreeFields
        add      esp, 4
        call     Phase4TrampolineThreePacked
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_9a52
        mov      dword ptr [g_eventQueueChild], 0x28
...
#ifdef NON_MATCHING
/* Ghidra-decompiled twin - behavior not yet runtime-verified */
void PendingMatch_CondPlayerLookup(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  if (iVar2 == 0) {
    CondPlayerLookup_004ac120();
    if (g_framePauseFlag != 0) {
      return;
    }
    MK4_NODE_AT(int, g_baseSel, 0x30) = (*(unsigned int *)MK4_VA(unsigned int, 0x542044));
    MK4_NODE_AT(int, g_baseSel, 0x34) = g_cj_0054205c;
    ScaledShrAnd();
    if (g_framePauseFlag != 0) {
      return;
    }
    MK4_NODE_AT(int, g_baseSel, 0x3c) = g_walkCallback;
    g_eventQueueCurrent = g_walkCallback;
    MK4_NODE_AT(int, g_baseSel, 0x40) = g_walkCallback;
    g_matrixStackTop = g_matrixStackTop + 1;
    *MK4_NODE(int, (int)g_matrixStackTop) = g_cj_00542054;
    g_walkCallback = g_eventQueueNotMask;
    g_cj_00542054 = 0x14dfd0;
    g_dlEnabledFlag = 1;
    DownloadPlayerChar();
    if (g_framePauseFlag != 0) {
      return;
  ...
  else if (iVar2 != 1) goto LAB_0048c6de;
  ScaledOrAh8CallPauseJmp();
  if (g_framePauseFlag != 0) {
    return;
  }
  g_cj_00542054 = 0x14e944;
  g_cj_00542058 = 0x14dfd2;
  if (g_cj_0054205c != g_player1NodeIdx) {
    g_cj_00542058 = 0x14e038;
    g_cj_00542054 = 0x14aabf;
  }
LAB_0048c6de:
  GuardedBitMaskFlagOrClear();
  if (g_framePauseFlag != 0) {
    return;
  }
  if ((g_xformDirtyFlags & 4) == 0) {
    MK4_NODE_AT(undefined4, g_baseSel, 0x38) = MK4_NODE_AT(undefined4, g_cj_00542058, 0);
    MK4_NODE_AT(undefined4, g_cj_00542058, 0) = g_eventQueueNotMask;
    g_walkCallback = g_eventQueueNotMask;
    g_eventQueueWorkType = MK4_NODE_AT(undefined4, g_cj_00542054, 0);
    g_eventQueueCurrent = MK4_NODE_AT(int, g_baseSel, 0x3c);
    MStackPush2BiasResolveChain();
    if (g_framePauseFlag != 0) {
      return;
    }
    if ((g_xformDirtyFlags & 4) == 0) {
      g_walkCallback = MK4_NODE_AT(undefined4, g_baseSel, 0x40);
      PushBitFieldMergePop();
      if (g_framePauseFlag == 0) {
        MK4_NODE_AT(undefined4, MK4_NODE_AT(int, g_baseSel, 0x30), 0x34) =
             MK4_NODE_AT(undefined4, g_cj_00542058, 0);
        (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = MK4_NODE_AT(int, g_cj_0054205c, 0x18);
        g_cj_00542058 = MK4_NODE_AT(int, g_baseSel, 0x34);
        g_eventQueuePending = MK4_NODE_AT(int, g_cj_00542058, 0x18);
        MK4_NODE_AT(int, g_cj_00542058, 0x18) = (*(unsigned int *)MK4_VA(unsigned int, 0x542044));
        MK4_NODE_AT(int, (*(unsigned int *)MK4_VA(unsigned int, 0x542044)), 0x18) = g_cj_00542058;
        MK4_NODE_AT(int, g_cj_0054205c, 0x18) = g_eventQueuePending;
        MK4_NODE_AT(int, g_eventQueuePending, 0x18) = g_cj_0054205c;
        g_walkCallback = MK4_NODE_AT(undefined4, g_cj_00542058, 0x1c);
        g_eventQueueCurrent = MK4_NODE_AT(int, g_cj_0054205c, 0x1c);
        MK4_NODE_AT(int, g_cj_00542058, 0x1c) = g_eventQueueCurrent;
        MK4_NODE_AT(int, g_cj_0054205c, 0x1c) = g_walkCallback;
        g_walkCallback = MK4_NODE_AT(undefined4, g_cj_0054205c, 0x58);
        MK4_NODE_AT(int, g_cj_00542058, 0x58) = g_walkCallback;
        MK4_NODE_AT(int, g_cj_00542058, 0x48) = g_walkCallback;
        g_xformDirtyFlags = g_xformDirtyFlags | 4;
        (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = MK4_NODE_AT(int, MK4_NODE_AT(int, g_cj_0054205c, 0x1c), 4);
        if (((((*(unsigned int *)MK4_VA(unsigned int, 0x542044)) == 0) || (g_xformDirtyFlags = g_xformDirtyFlags ^ 4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) < 1)) ||
            (BootChainBidirRecurseWalk(), g_framePauseFlag == 0)) && (MStackCall_MStackPush2ChainLLInsert(), g_framePauseFlag == 0)) {
          g_xformDirtyFlags = g_xformDirtyFlags | 4;
          g_cj_0054205c = g_cj_00542058;
          if (((*(unsigned int *)MK4_VA(unsigned int, 0x542044)) != 0) && (g_xformDirtyFlags = g_xformDirtyFlags ^ 4, 0 < (*(unsigned int *)MK4_VA(unsigned int, 0x542044)))) {
            g_matrixStackTop = g_matrixStackTop + 1;
            *MK4_NODE(int, (int)g_matrixStackTop) = (*(unsigned int *)MK4_VA(unsigned int, 0x542044));
            ...
            g_eventQueuePending = MK4_NODE_AT(int, g_cj_0054205c, 0x1c);
            PushSetCallCleanup();
            if (g_framePauseFlag != 0) {
              return;
            }
          }
          MK4_NODE_AT(uint, g_cj_0054205c, 0x34) = MK4_NODE_AT(uint, g_cj_0054205c, 0x34) & 0xfffff7ff;
          ...
          if (g_framePauseFlag == 0) {
            ...
            if ((g_framePauseFlag == 0) && (TwoCallJmp(), g_framePauseFlag == 0)) {
    ...
    g_walkCallback = MK4_NODE_AT(int, g_baseSel, 0x38);
    MK4_NODE_AT(int, g_cj_00542058, 0) = g_walkCallback;
  }
  *(code **)(iVar1 + 8) = PendingMatch_CondPlayerLookup;
...
__declspec(naked) void PendingMatch_CondPlayerLookup(void)
{
    ...
    L_c687:
        ...
        mov      dword ptr [g_eventQueueEnd], eax
    L_c6de:
        call     GuardedBitMaskFlagOrClear
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_ca97
        test     byte ptr [g_xformDirtyFlags], 4
        ...
        mov      dword ptr [g_eventQueueCurrent], ecx
        call     MStackPush2BiasResolveChain
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_ca97
        mov      al, byte ptr [g_xformDirtyFlags]
    ...
    L_c9d5:
        ...
        and      dh, 0xf7
        mov      dword ptr [ecx*4 + 0x34], edx
        call     BootMStackBracket3SubdispatchPair
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_ca97
        mov      ecx, dword ptr [g_fightGroupHead]
        ...
        mov      ecx, dword ptr [eax*4]
        mov      dword ptr [g_eventQueueWorkType], ecx
        call     PushCallPopScaledJmpIndirect
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_ca97
        call     TwoCallJmp
    ...
    L_cae5:
        ...
        mov      dword ptr [g_eventQueueNotMask], eax
        mov      dword ptr [g_fightGroupHead], ecx
        mov      dword ptr [g_eventQueueEnd], 0x12c
...

{
  ...
  *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x146e2e0;
...
__declspec(naked) void PendingMatch_SlotEvent3EntryChain(void)
{
    ...
    L_e7be:
        mov      dword ptr [g_walkCallback], 9
        call     ScaledArrStore_GuardedChainCmpDualBitXor_00429960
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_e7e8
        mov      eax, 0x4eb668
...
#ifdef NON_MATCHING
/* Ghidra-decompiled twin - behavior not yet runtime-verified */
void PendingMatch_DispatcherComplex138(void)

{
  g_dispatchVar17 = MK4_NODE_AT(int, g_cj_00542054, 0x58) - MK4_NODE_AT(int, g_cj_00542054, 0x48);
  g_dispatchVar18 = MK4_NODE_AT(undefined4, g_cj_00542054, 0x54);
  g_dispatchVar16 = MK4_NODE_AT(undefined4, g_cj_00542054, 0x5c);
  (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = 0;
  g_walkCallback = 0x93;
  DispatcherComplex138_00476060();
  while ((g_framePauseFlag == 0 && (((byte)g_xformDirtyFlags & 4) == 0))) {
    MK4_NODE_AT(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044)), 0x54) = g_dispatchVar18;
    MK4_NODE_AT(int, (*(unsigned int *)MK4_VA(unsigned int, 0x542044)), 0x58) = g_dispatchVar17;
    MK4_NODE_AT(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044)), 0x5c) = g_dispatchVar16;
    g_walkCallback = 0x93;
    DispatcherComplex138_00476060();
  }
  return;
...
__declspec(naked) void PendingMatch_DispatcherComplex138(void)
{
    __asm {
        ...
        sub      ecx, edx
        mov      dword ptr [g_walkCallback], ecx
        mov      dword ptr [g_dispatchVar17], ecx
        mov      ecx, dword ptr [eax*4 + 0x54]
        mov      dword ptr [g_walkCallback], ecx
        mov      dword ptr [g_dispatchVar18], ecx
        mov      eax, dword ptr [eax*4 + 0x5c]
        mov      dword ptr [g_currentNodeIdx], 0
        mov      dword ptr [g_dispatchVar16], eax
        mov      dword ptr [g_walkCallback], esi
        call     DispatcherComplex138_00476060
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
    ...
    L_072d:
        ...
        jne      L_0780
        mov      ecx, dword ptr [g_currentNodeIdx]
        mov      edx, dword ptr [g_dispatchVar18]
        mov      dword ptr [ecx*4 + 0x54], edx
        mov      eax, dword ptr [g_currentNodeIdx]
        mov      ecx, dword ptr [g_dispatchVar17]
        mov      dword ptr [eax*4 + 0x58], ecx
        mov      eax, dword ptr [g_currentNodeIdx]
        mov      edx, dword ptr [g_dispatchVar16]
        mov      dword ptr [eax*4 + 0x5c], edx
        mov      dword ptr [g_walkCallback], esi
        call     DispatcherComplex138_00476060
        mov      eax, dword ptr [g_framePauseFlag]
    ...
    L_0842:
        ...
        mov      ecx, dword ptr [g_eventQueueEnd]
        mov      edx, dword ptr [g_currentNodeIdx]
        mov      eax, dword ptr [g_dispatchVar18]
        inc      ecx
        mov      dword ptr [g_eventQueueEnd], ecx
        mov      dword ptr [edx*4 + 0x54], eax
        mov      ecx, dword ptr [g_currentNodeIdx]
        mov      edx, dword ptr [g_dispatchVar17]
        mov      dword ptr [ecx*4 + 0x58], edx
        mov      eax, dword ptr [g_currentNodeIdx]
        mov      ecx, dword ptr [g_dispatchVar16]
        mov      dword ptr [eax*4 + 0x5c], ecx
    ...
    L_0a26:
        ...
        cmp      dword ptr [g_framePauseFlag], edi
        jne      L_0d23
        call     ScaledSaveCallRestoreJmp_InstallSelfMagicShift_then_MStackPush2ChainLLInsert_00472f80
        cmp      dword ptr [g_framePauseFlag], edi
        jne      L_0d23
        mov      edx, dword ptr [g_fightGroupHead]
        mov      eax, 0x501184
        ...
        mov      dword ptr [g_walkCallback], eax
        mov      dword ptr [ecx*4 + 0x24], eax
        mov      dword ptr [g_eventQueueChild], 0x9f
        mov      dword ptr [esi + 8], 0x450990
        mov      edx, dword ptr [g_baseSel]
        mov      ecx, 0x450990
        mov      dword ptr [edx*4 + 0x84], 4
        ...
        jne      L_0d23
        mov      edx, dword ptr [g_eventQueueIdx]
        mov      dword ptr [g_currentNodeFlags], 0x20ccc
        mov      dword ptr [g_fightGroupHead], edx
        call     GameInstall2BodyMul10ScaledInit
        cmp      dword ptr [g_framePauseFlag], edi
        jne      L_0d23
    ...
    L_0cab:
        ...
        mov      dword ptr [g_walkCallback], eax
        mov      dword ptr [ecx*4 + 0x28], eax
        mov      dword ptr [g_eventQueueChild], 0x206
        mov      dword ptr [esi + 8], 0x450990
        mov      edx, dword ptr [g_baseSel]
        mov      ecx, 0x450990
    ...
    L_0d79:
        ...
        mov      dword ptr [eax + 0x84], ecx
        mov      dword ptr [g_pendingNodeType], 0x89
        mov      dword ptr [g_framePauseFlag], ecx
    L_0d9b:
        ret      
        nop      
...
#ifdef NON_MATCHING
/* Ghidra-decompiled twin - behavior not yet runtime-verified */
void PendingMatch_ZeroAndDirty4_00471e00(void)
...
__declspec(naked) void PendingMatch_ZeroAndDirty4_00471e00(void)
{
    ...
    L_205a:
        ...
        ret      
    L_2062:
        mov      dword ptr [g_eventQueueCurrent], 0x10000
        mov      dword ptr [g_eventQueueWorkType], 0xb333
    ...
    L_24a5:
        ...
        je       L_24f3
        mov      dword ptr [g_eventQueueCurrent], 0
        mov      dword ptr [g_eventQueueWorkType], 0x2666
        call     DualEntryRecursiveInstall
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_2555
...

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  if (iVar2 == 0) {
    g_cj_00542054 = 3;
    g_currentNodeFlags = 0x28f;
  }
  iVar2 = MK4_NODE_AT(int, g_cj_0054205c, 0x58);
  do {
    if (iVar2 < -0xccb) {
      g_walkCallback = g_currentNodeFlags + MK4_NODE_AT(int, g_cj_0054205c, 0x70);
      MK4_NODE_AT(int, g_cj_0054205c, 0x70) = g_walkCallback;
      *(code **)(iVar1 + 8) = PendingMatch_StackPopDispatchTagged_00466fc0;
      *(undefined4 *)(iVar1 + 0x84) = 1;
      g_dualC = 1;
      g_framePauseFlag = 1;
      return;
    ...
    *(undefined4 *)(iVar2 + 0x58) = 0xfffff0a4;
    iVar2 = *(int *)(iVar2 + 0x78);
    if (iVar2 != 0) {
      if (iVar2 < 1) {
        iVar2 = iVar2 + 0x3333;
        if (-0xccd < iVar2) goto LAB_00467058;
      }
      else {
        iVar2 = iVar2 + -0x3333;
        if (iVar2 < 0xccd) {
LAB_00467058:
    ...
    MK4_NODE_AT(int, g_cj_0054205c, 0x78) = iVar2;
    ...
    MK4_NODE_AT(undefined4, g_cj_0054205c, 0x70) = 0xffffee15;
    iVar2 = MK4_NODE_AT(int, g_cj_0054205c, 0x58);
  } while( true );
}
#else
__declspec(naked) void PendingMatch_StackPopDispatchTagged_00466fc0(void)
{
    ...
    L_7155:
        ...
        mov      edx, dword ptr [eax*4 + 0x68]
        mov      dword ptr [g_eventQueueIdx], edx
        mov      dword ptr [g_eventQueueWorkType], 0x26e
        mov      dword ptr [g_pendingNodeType], 0x467600
        call     AllocNode
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_75ec
    ...
    L_7311:
        ...
        sar      edx, 2
        mov      dword ptr [g_eventQueueCurrent], edx
        call     MStackBracketedStoreTwoCall
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_75ec
    L_7368:
    ...
    L_75ec:
        ...
        je       L_7667
        dec      eax
        mov      dword ptr [g_walkCallback], 0x1e
        call     GatedWordPushCall
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_770b
        ...
        mov      dword ptr [esi + 0x84], 2
        mov      dword ptr [g_pendingNodeType], 0x2f
        mov      dword ptr [g_framePauseFlag], 1
        pop      esi
        ret      
    L_7667:
        ...
        test     eax, eax
        jne      L_770b
        mov      dword ptr [g_eventQueueWorkType], 0x26f
        mov      dword ptr [g_pendingNodeType], 0x467710
        call     AllocNode
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_770b
        mov      dword ptr [g_walkCallback], 0x2c
        call     GatedWordPushCall
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_770b
        mov      edx, dword ptr [g_eventArmReload]
        mov      eax, 1
        mov      dword ptr [g_dispatchSave88], edx
        mov      dword ptr [esi + 8], 0x467600
        mov      dword ptr [esi + 0x84], eax
    ...
    L_770b:
        ...
        test     eax, eax
        jne      L_7796
        add      dword ptr [g_walkCallback], 0x1f
        call     GatedWordPushCall
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_7796
...

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  if (iVar2 == 0) {
    ...
    *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x1448750;
    (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) + 1;
...
#ifdef NON_MATCHING
/* Ghidra-decompiled twin - behavior not yet runtime-verified */
void PendingMatch_MStackPush2RunCountdown_0044baa0(void)
...
__declspec(naked) void PendingMatch_MStackPush2RunCountdown_0044baa0(void)
{
    ...
    L_bb88:
        mov      eax, dword ptr [ecx*4 + 0x58]
        mov      dword ptr [g_eventQueueCurrent], 0x1eb
        add      eax, 0x1eb
        mov      dword ptr [g_walkCallback], eax
        mov      dword ptr [ecx*4 + 0x58], eax
        mov      eax, 1
    ...
    L_bbcc:
        ...
        mov      dword ptr [g_walkCallback], 0xfffe8000
        call     MStackPush3SideStore
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_bc42
        ...
        mov      dword ptr [esi + 8], 0x44bb30
        mov      dword ptr [esi + 0x84], eax
        mov      dword ptr [g_pendingNodeType], 0x118
        mov      dword ptr [g_framePauseFlag], eax
    L_bc42:
        pop      esi
        ret      
    ...
    L_bdfb:
        ...
        jne      L_be66
        mov      eax, dword ptr [g_eventQueueIdx]
        mov      dword ptr [g_currentNodeFlags], 0x11999
        mov      dword ptr [g_fightGroupHead], eax
        call     GameInstall2BodyMul10ScaledInit
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
...
#ifdef NON_MATCHING
/* Ghidra-decompiled twin - behavior not yet runtime-verified */
void PendingMatch_Thunk_ScaledNeg1SetPause(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x74) = g_walkCallback;
  iVar2 = *(int *)(iVar1 + 0x18) * 4;
  iVar3 = g_dualD * 4;
  *(uint *)(iVar2 + 0x20) = MK4_NODE_AT(uint, *(int *)(iVar1 + 0x18), 0x20) & 0xfaffffff | 0xa000000;
  *(undefined4 *)(iVar2 + 0x3c) = *(undefined4 *)(iVar3 + 0x14);
  *(undefined4 *)(iVar2 + 0x40) = *(undefined4 *)(iVar3 + 0x18);
  g_walkCallback = *(undefined4 *)(iVar3 + 0x1c);
  *(undefined4 *)(iVar2 + 0x44) = g_walkCallback;
  g_eventQueueCurrent = *MK4_NODE(undefined4, (int)g_matrixStackTop);
  g_cj_00542058 = *MK4_NODE(undefined4, (int)(g_matrixStackTop + -1));
  g_eventQueuePending = *MK4_NODE(undefined4, (int)(g_matrixStackTop + -2));
...
__declspec(naked) void PendingMatch_Thunk_ScaledNeg1SetPause(void)
{
    __asm {
        ...
        mov      dword ptr [g_xformEntityIdx], eax
        mov      ecx, dword ptr [eax*4 + 0x20]
        mov      dword ptr [g_eventQueueCurrent], 0xa000000
        and      ecx, 0xfaffffff
        or       ecx, 0xa000000
        shl      eax, 2
        shl      edx, 2
    ...
    L_34a9:
        ...
        mov      dword ptr [g_walkCallback], 0xfffe4000
        call     MStackPush3SideStore
        cmp      dword ptr [g_framePauseFlag], edi
        jne      L_3583
    ...
    L_3697:
        ...
        mov      dword ptr [g_eventQueueEnd], edx
        mov      dword ptr [g_eventQueueNotMask], edi
        mov      dword ptr [g_xformScratch2088], 0xf5c
    ...
    L_3830:
        ...
        mov      dword ptr [g_eventQueueCurrent], 0x147
        add      ecx, 0x147
        cmp      ecx, 0xffff0000
        mov      dword ptr [g_walkCallback], ecx
        jl       L_386b
    ...
    L_3a0c:
        ...
        test     eax, eax
        jne      L_3a88
        call     SetWalk0xaCrossStore
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_3a88
        call     SpecialInitDirtyJmp
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_3a88
        test     byte ptr [g_xformDirtyFlags], 4
    ...
    L_3a44:
        ...
        test     eax, eax
        jne      L_3a88
        call     TripleSetCallPauseDirtyJmp
        mov      eax, dword ptr [g_framePauseFlag]
        test     eax, eax
        jne      L_3a88
        push     0x443d30
    ...
    L_3aff:
        mov      ecx, 0x501034
        mov      dword ptr [g_eventQueueChild], 0x69
        shr      ecx, 2
        mov      dword ptr [g_eventQueueEnd], ecx
        mov      dword ptr [g_currentNodeFlags], 0x1958
        mov      dword ptr [g_xformScratch2088], 0x1999
    ...
    L_3bcf:
        ...
        shr      ecx, 2
        mov      dword ptr [g_eventQueueEnd], ecx
        mov      dword ptr [g_currentNodeFlags], 0x1332
        mov      dword ptr [g_xformScratch2088], 0x1333
        mov      dword ptr [g_eventQueueIdx], 0
...
#ifdef NON_MATCHING
/* Ghidra-decompiled twin - behavior not yet runtime-verified */
void PendingMatch_ScaledIterStep(void)

{
  if (((byte)g_xformDirtyFlags & 1) != 0) {
    MoveListCursorCluster();
    return;
  }
...
__declspec(naked) void PendingMatch_ScaledIterStep(void)
{
    ...
    L_bb44:
        ...
        mov      eax, 1
        mov      dword ptr [g_walkCallback], eax
        mov      dword ptr [g_dispatchVar11], eax
        jmp      PendingMatch_00459510
        nop      
        nop      
        nop      
