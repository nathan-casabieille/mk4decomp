...
/* Portable twin. The same matrix snapshot as DirtyTestScaledCopy but taken
...
void WtSnapshotPushCall(void)
{
    ...
    /* The 3x3 is NINE PACKED s16 from 0x007af990, moved as four dwords plus a
     * trailing halfword; writing through the s16 array a word at a time would
     * be a different access width. */
