 ...
 *   g_eventQueueCurrent = esi; g_walkCallback = edx;
 *   [eax+0x34] = edx;
...
void DualSlotCopyChain_004756f0(void) {
    ...
    a <<= 2;
    c <<= 2;
    v = *(unsigned int *)(a + 0x34);
    g_walkCallback = (void (*)(void))v;
    bit = *(unsigned int *)(c + 0x34) & 1;
    v = (v & 0xfffffffe) | bit;
    g_eventQueueCurrent = bit;
    g_walkCallback = (void (*)(void))v;
    *(unsigned int *)(a + 0x34) = v;
    v = *(unsigned int *)(c + 0x60);
    g_walkCallback = (void (*)(void))v;
    *(unsigned int *)(a + 0x60) = v;
    v = *(unsigned int *)(c + 0x64);
    g_walkCallback = (void (*)(void))v;
    *(unsigned int *)(a + 0x64) = v;
    v = *(unsigned int *)(c + 0x68);
    g_walkCallback = (void (*)(void))v;
    *(unsigned int *)(a + 0x68) = v;
}
