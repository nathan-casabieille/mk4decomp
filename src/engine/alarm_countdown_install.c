...
#define g_dispatchSave959 (*(unsigned int *)MK4_VA(unsigned int, 0x4e9f78u))
#define g_dispatchSave960 (*(unsigned int *)MK4_VA(unsigned int, 0x4e9f80u))
#define g_dispatchTableArr10 (*(unsigned int *)MK4_VA(unsigned int, 0x500c50u))
