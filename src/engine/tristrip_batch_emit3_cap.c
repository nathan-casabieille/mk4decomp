        ...
        if ((((uVar3 != (g_vtxValid == 0)) && (0 < (int)g_min_007af984)) && (0 < (int)g_min_007af988)) &&
          ...
          *(ushort *)(puVar7 + 5) = local_8;
          if (g_dispatchSave1570 != 0) {
            if (g_screenH < *(short *)(void *)((char *)puVar7 + 2)) {
              *(short *)(void *)((char *)puVar7 + 2) = g_screenH;
            }
            if (g_screenH < *(short *)(void *)((char *)puVar7 + 6)) {
              *(short *)(void *)((char *)puVar7 + 6) = g_screenH;
            }
            if (g_screenH < *(short *)(void *)((char *)puVar7 + 10)) {
              *(short *)(void *)((char *)puVar7 + 10) = g_screenH;
            }
          }
