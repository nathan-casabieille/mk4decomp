 ...
 *   call GuardedChainCmpDualBitXor_004299a0; if pause: ret;
 *   call DirtyToggleByGate_0048f350; if pause: ret;
 ...
 *   skip: ++g_matrixStackTop; [mstack*4]=0x491660; jmp GameDispatchValidateState_004339c0.
 */
