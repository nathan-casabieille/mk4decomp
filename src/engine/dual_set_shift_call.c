 ...
 *   call ChainDirtyBitWalker then move (wt,g_acc) into (g_pendingNodeType,
 *   g_walkCallback); call ChainDirtyBitWalker again; on pause clear shift
 *   wt/g_pendingNodeType by +0xf, snapshot cj from g_savedNode, call
