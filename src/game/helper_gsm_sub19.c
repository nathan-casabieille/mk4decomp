...
__declspec(naked) void Helper_GSM_Sub19(void)
{
    __asm
    {
        ...
        mov     bl, al
        push    offset g_data_004f5018
        or      bl, 1
        push    0
        mov     byte ptr [g_byte_00ab4300], bl
        call    TableSearchAsc_004b6300
        add     esp, 8
        mov     dword ptr [g_data_00ab4320], eax
        jmp     short L_b73_afterFirst
    L_b73_skipSet:
        mov     eax, dword ptr [g_data_00ab4320]
    L_b73_afterFirst:
        mov     ecx, dword ptr [g_data_00ab4368]
        sub     ecx, 0
        je      L_b73_case0
        sub     ecx, 2
        ...
        sub     ecx, 0x43
        jne     L_b73_drawMenu
        mov     dword ptr [g_data_00ab4368], 0
        jmp     L_b73_drawMenu
    L_b73_case2:
        push    1
    ...
    L_b73_checkBit5:
        ...
        mov     dword ptr [g_data_00ab4368], 0x45
        jmp     short L_b73_drawMenu
    L_b73_case0:
        mov     dword ptr [g_data_00ab4368], 2
    L_b73_drawMenu:
        push    eax
        push    offset g_data_004f5018
        call    DrawMenu
        mov     eax, dword ptr [g_data_00ab4368]
        add     esp, 8
        pop     esi
        pop     ebx
        ret
