  ...
  *MK4_NODE(int, (int)g_matrixStackTop) = g_cj_0054205c;
  ...
  while( true ) {
    if (g_walkCallback == 0) {
      ...
      (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *MK4_NODE(undefined4, (int)(g_matrixStackTop + -3));
    ...
    if ((((byte)g_xformDirtyFlags & 4) == 0) && (MK4_NODE_AT(int, (*(unsigned int *)MK4_VA(unsigned int, 0x542044)), 0x28) != 0)) {
