  ...
  *(int *)((int)g_matrixStackTop * 4) = g_cj_0054205c;
  ...
  while( true ) {
    if (g_walkCallback == 0) {
      ...
      (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(undefined4 *)((int)(g_matrixStackTop + -3) * 4);
    ...
    if ((((byte)g_xformDirtyFlags & 4) == 0) && (*(int *)((*(unsigned int *)MK4_VA(unsigned int, 0x542044)) * 4 + 0x28) != 0)) {
