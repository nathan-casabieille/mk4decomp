 ...
 *   If was nonzero: decrement g_state_0054207c; if still > 0 → fall through to LinkSiblingsAndInstallSelf_00414670 path.
 *     Else: g_x_00542044 = g_cj_00542058; call MStackPush2ChainLLInsert_00406790; if paused: pop+ret.
