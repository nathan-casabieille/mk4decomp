...
void InstallSelfMStackPush_StackPopDispatchTagged(void)

{
  ...
  *(undefined4 *)(iVar1 + 0x84) = 0;
  ...
  if (g_framePauseFlag == 0) {
    *(code **)(iVar1 + 8) = InstallSelfMStackPush_StackPopDispatchTagged;
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 1;
    (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = *(int *)(iVar1 + 4);
    *MK4_NODE(undefined4, (*(unsigned int *)MK4_VA(unsigned int, 0x542044))) = 0x141aaf0;
    (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) = (*(unsigned int *)MK4_VA(unsigned int, 0x542044)) + 1;
    *(int *)(iVar1 + 4) = (*(unsigned int *)MK4_VA(unsigned int, 0x542044));
    MK4_NODE_AT(undefined4, g_baseSel, 0x84) = 0;
    KnockbackPositionReset();
    g_framePauseFlag = 1;
  }
  return;
}
#else
__declspec(naked) void InstallSelfMStackPush_StackPopDispatchTagged(void) {
    __asm {
        ...
        _emit   75h
        _emit   5fh
        mov     dword ptr [esi + 8], offset InstallSelfMStackPush_StackPopDispatchTagged
        mov     ecx, dword ptr [g_baseSel]
        mov     edx, offset InstallSelfMStackPush_StackPopDispatchTagged
