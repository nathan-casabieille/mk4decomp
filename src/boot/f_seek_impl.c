...
int FSeekImpl(int param_1,int param_2,int param_3)

{
  ...
  if (((*(uint *)(param_1 + 0xc) & 0x83) != 0) &&
    ...
    *(uint *)(param_1 + 0xc) = *(uint *)(param_1 + 0xc) & 0xffffffef;
    if (param_3 == 1) {
      iVar2 = FileTellAdjusted(param_1);
    ...
    iVar2 = IOWrapper_CritSecLazyEnter_004c8dd0(*(undefined4 *)(param_1 + 0x10),param_2,param_3);
    return (iVar2 != -1) - 1;
  }
  puVar3 = (undefined4 *)Crt_errno();
  *puVar3 = 0x16;
  return -1;
}
#else
