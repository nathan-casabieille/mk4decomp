...
uint FWriteNoLock(char *param_1,uint param_2,uint param_3,int *param_4)

{
  ...
  do {
    if (((piVar1[3] & 0x108U) == 0) || (uVar2 = piVar1[1], uVar2 == 0)) {
      if (uVar6 < param_4) {
        iVar3 = Flsbuf((int)*param_1,piVar1);
        if (iVar3 == -1) goto LAB_004c60f4;
        ...
        if (((piVar1[3] & 0x108U) != 0) && (iVar3 = FFlushImpl(piVar1), iVar3 != 0)) {
LAB_004c60f4:
        ...
        uVar4 = IOWrapper_CritSecLazyEnter_004c9ae0(piVar1[4],param_1,uVar2);
        if (uVar4 == 0xffffffff) {
LAB_004c60d9:
        ...
        if (uVar4 < uVar2) goto LAB_004c60d9;
      }
    }
    else {
      if (uVar6 < uVar2) {
