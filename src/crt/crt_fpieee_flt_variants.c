...
void Crt_fpieee_flt(int param_1,int *param_2,ushort *param_3)

{
  ...
  iVar1 = CrtFpuExceptionFilter(uVar2,param_2 + 6,param_3);
  if (iVar1 == 0) {
    ...
    CrtFpieeeFlt(local_58,&param_3,uVar2,param_1,param_2 + 2,param_2 + 6);
  }
switchD_004cdd3f_caseD_6:
  FpuMaskMerge(param_3,0xffff);
  iVar1 = 0;
  if ((*param_2 != 8) && (g_crtFpuExceptionMask == 0)) {
    iVar1 = RetZero_004cf700(param_2);
  }
  if (iVar1 == 0) {
    SwitchErrorCode(*param_2);
  }
  return;
}
#else
