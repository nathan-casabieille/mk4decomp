...
int FormatHelper(undefined4 *param_1,int param_2,int param_3)

{
  ...
  FpFormatRound((uint)(local_28 == 0x2d) + param_2,local_24 + param_3,&local_28);
  FcvtFormatDecimal(param_2,param_3,&local_28,0);
  return param_2;
}
#else
