...
__declspec(naked) void CrtSetlocaleInstaller_004c9520(void)
{
    ...
    L_95ea:
        ...
        ja       short L_9613
    L_95ff:
        mov      bl, byte ptr [eax + g_data_00f9f8c1]
        or       bl, 4
        mov      byte ptr [eax + g_data_00f9f8c1], bl
        inc      eax
        cmp      eax, ecx
        jbe      short L_95ff
    L_9613:
    ...
    L_96e1:
        or       byte ptr [eax + g_data_00f9f8c1], dl
        inc      eax
        cmp      eax, ecx
        jbe      short L_96e1
    L_96ec:
    ...
    L_96f6:
        ...
        call     TranslateMsgId_004c97a0
        mov      ecx, dword ptr [ebx + g_data_00522314]
        mov      edx, dword ptr [ebx + g_data_00522318]
        mov      dword ptr [g_data_00f9facc], eax
        lea      eax, [ebx + g_data_00522314]
        add      esp, 4
