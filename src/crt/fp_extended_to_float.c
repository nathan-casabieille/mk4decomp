...
undefined4 FpExtendedToFloat(ushort *param_1,uint *param_2,int *param_3)

{
  ...
  if (iVar5 == -0x3fff) {
    iVar5 = 0;
    iVar2 = LinearSearchArray(&local_18);
    if (iVar2 == 0) {
      ZeroThreeFromArg(&local_18);
      uVar3 = 2;
      goto LAB_004ccc91;
    }
  }
  else {
    Copy3Dwords(local_c,&local_18);
    iVar2 = BitsetReserve(&local_18,param_3[2]);
    if (iVar2 != 0) {
      iVar5 = uVar4 - 0x3ffe;
    }
    iVar2 = param_3[1];
    ...
    if (iVar5 <= iVar2) {
      Copy3Dwords(&local_18,local_c);
      BitShiftMultiPrecision(&local_18,iVar2 - iVar5);
      BitsetReserve(&local_18,param_3[2]);
      BitShiftMultiPrecision(&local_18,param_3[3] + 1);
      iVar5 = 0;
      uVar3 = 2;
      goto LAB_004ccc91;
    }
    if (*param_3 <= iVar5) {
      ...
      BitShiftMultiPrecision(&local_18,param_3[3]);
