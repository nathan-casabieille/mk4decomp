...
int PrintfStubSigned(undefined4 *param_1,int param_2,int param_3,undefined4 param_4)

{
  ...
  FpFormatRound((uint)(local_28[0] == 0x2d) + param_2 + (uint)(0 < param_3),param_3 + 1,local_28);
  CfltcvtFormat(param_2,param_3,param_4,local_28,0);
  return param_2;
}
#else
