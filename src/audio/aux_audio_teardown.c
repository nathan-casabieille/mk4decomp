...
#define g_auxChannels (*(unsigned int *)MK4_VA(unsigned int, 0x5438a8u))
#define g_auxCount (*(unsigned int *)MK4_VA(unsigned int, 0x5438a0u))
...
#define g_iat_auxSetVolume (*(unsigned int *)MK4_VA(unsigned int, 0x4d2230u))
