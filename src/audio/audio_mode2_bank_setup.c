...
extern unsigned char g_audioStateByte840;
extern unsigned char g_audioStateByte83c;
extern unsigned char g_audioBank2Base;
extern unsigned char g_audioByteCounterChainSt;
