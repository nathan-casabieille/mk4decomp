 ...
 *   g_x_0054206c=0; CopyGlobal_004ac1f0; func_004a2080.
...
__declspec(naked) void AudioPreloadStreamingTrack_004a6e70(void)
{
    ...
    L_6f7f:
        ...
        add      esp, 0xc
        inc      ecx
        mov      dword ptr [g_data_0054204c], OFFSET PendingMatch_004a62b0
...
__declspec(naked) void PendingMatch_004a70f0(void)
{
    ...
    L_714c:
        ...
        test     byte ptr [g_data_0054206c], 0xf
        jne      L_724e
    ...
    L_724e:
        mov      esi, dword ptr [g_data_0052ab10]
        ...
        call     Push16Call_00489f50
        call     BootInitGuardedCallChain_004265d0
        mov      dword ptr [g_data_0054204c], 0x401b70
        mov      dword ptr [g_data_00542074], 0x1000
        call     AllocNode
        cmp      dword ptr [g_data_00541e6c], edi
        jne      L_75fb
    ...
    L_72fd:
        ...
        cmp      dword ptr [g_data_00541e6c], edi
        jne      L_75fb
        cmp      dword ptr [g_data_005433b8], 4
        jne      L_746c
        mov      eax, dword ptr [g_data_00543830]
        mov      eax, dword ptr [eax*4 + g_data_004f3a58]
        lea      ecx, [eax + eax*2]
        lea      esi, [ecx*8 + g_data_005435a0]
        jmp      L_7483
    L_746c:
        mov      edx, dword ptr [g_data_00543830]
        mov      eax, dword ptr [edx*4 + g_data_004f3a70]
        lea      eax, [eax + eax*2]
        lea      esi, [eax*8 + g_data_005435a0]
    L_7483:
        push     0x280000
        push     0x4d25a8
        ...
        movsx    eax, byte ptr [eax + g_data_004f3ac8]
        mov      dword ptr [g_data_0054206c], eax
...
__declspec(naked) void PendingMatch_004a3400(void)
{
    __asm {
        ...
        mov      al, byte ptr [g_data_004d50a4]
        mov      esi, 3
        test     al, 0x20
        jne      L_34a1
        test     byte ptr [g_data_004d50a8], 2
        jne      L_34a1
        mov      ecx, dword ptr [g_data_00542060]
        ...
        jle      L_3483
        mov      dword ptr [g_data_00542074], 0xcc6
        call     Push16Call_00489f50
    ...
    L_3483:
        cmp      eax, 0x12c
        jne      L_34a1
        mov      dword ptr [g_data_00542074], 0x18bf
        call     Push16Call_00489f50
        jmp      L_34a1
    L_349b:
    ...
    L_34a1:
        ...
        cmp      eax, 7
        jne      L_352d
        mov      dword ptr [g_data_00542074], 0x32a
        call     Push16Call_00489f50
        call     VoiceBankTickDispatch_004a3120
        mov      dword ptr [g_data_00542070], 0x20
    ...
    L_35dc:
        ...
        mov      byte ptr [g_data_00543590], al
        ...
        cmp      eax, esi
        mov      dword ptr [g_data_005380e0], edx
        je       L_36e5
        cmp      dword ptr [g_data_00537e88], ebx
        jne      L_36bd
        mov      ecx, 0x537e88
        mov      edx, 0x53a700
        shr      ecx, 2
        ...
        call     DualScaledStoreConst_004a22c0
    L_36bd:
        cmp      dword ptr [g_data_0053a408], ebx
        jne      L_36e5
        mov      eax, 0x53a408
        mov      ecx, 0x53a3e0
        shr      eax, 2
    ...
    L_36e5:
        ...
        pop      ebx
        ret      
        movsx    eax, byte ptr [g_data_00543590]
        mov      ebp, 1
        mov      dword ptr [g_data_00543438], ebx
        mov      dword ptr [g_data_0052aac4], 2
        ...
        mov      dword ptr [g_data_00542074], 9
        call     Push16Call_00489f50
        mov      dword ptr [g_data_00542080], 0x1c20
        mov      esi, 0x4f326c
    L_379b:
    ...
    L_381d:
        ...
        cmp      dword ptr [g_data_00541e6c], ebx
        jne      L_38b1
        mov      ecx, dword ptr [g_data_00537f48]
        mov      eax, 0x535cfc
        shr      eax, 2
        ...
        mov      dword ptr [g_data_0052aac4], ebp
        mov      dword ptr [g_data_00543438], esi
...
__declspec(naked) void PendingMatch_004a56c0(void)
{
    ...
    L_5938:
        test     byte ptr [g_data_0053a498], 8
        je       L_5948
    ...
    L_5ab3:
        ...
        xor      ebp, ebp
    L_5ada:
        mov      ecx, dword ptr [g_data_004d50b4]
        test     cl, 1
        jne      L_5aea
        test     ch, 1
        je       L_5b55
    ...
    L_5b5a:
        ...
        je       L_5be3
    L_5b64:
        mov      edx, dword ptr [g_data_005433b8]
        mov      ecx, dword ptr [eax*4 + 0x30]
        dec      edx
        cmp      ecx, edx
        jge      L_5be3
    ...
    L_5d35:
        ...
        mov      dword ptr [g_data_0054355c], ebp
        call     DrainQueueCallEach_004a1ec0
        call     Audio11SlotInitLoop_004a5540
        mov      esi, 0x4f3940
    L_5d63:
        movsx    eax, byte ptr [esi]
        add      eax, dword ptr [g_data_00542060]
        mov      ecx, dword ptr [eax*4]
        mov      dword ptr [g_data_00542044], ecx
        call     MStackPush2ChainLLInsert_00406790
        add      esi, 0x24
