 ...
 *   save walk in esi, call MStackBracket4_ListInsertZeroFill_00408600; gate pause; gate state-bit 2;
 *   call MStackPush3LinkedListWalk_004088b0; gate pause; deref walk[+0x18][+0x28] into wt;
