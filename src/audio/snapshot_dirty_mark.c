 ...
 *   save walk in esi, call MStackBracket4_ListInsertZeroFill; gate pause; gate state-bit 2;
 *   call MStackPush3LinkedListWalk; gate pause; deref walk[+0x18][+0x28] into wt;
