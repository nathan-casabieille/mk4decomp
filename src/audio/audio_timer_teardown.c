...
#define g_audioState00 (*(unsigned int *)MK4_VA(unsigned int, 0x543900u))
...
#define g_timerActive (*(unsigned int *)MK4_VA(unsigned int, 0x5438ecu))
#define g_timerEndSec (*(unsigned int *)MK4_VA(unsigned int, 0x5438f4u))
#define g_timerFlag (*(unsigned int *)MK4_VA(unsigned int, 0x543904u))
#define g_timerHandle (*(unsigned int *)MK4_VA(unsigned int, 0x5438f8u))
#define g_timerLastNow (*(unsigned int *)MK4_VA(unsigned int, 0x5438fcu))
#define g_timerStartSec (*(unsigned int *)MK4_VA(unsigned int, 0x5438f0u))
