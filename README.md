...
| **Pure C (no `__asm`)** | **~42%** (1234 / 2853 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2853 functions) |
| Still `__declspec(naked)` | ~48% (1343 / 2853 functions) |
