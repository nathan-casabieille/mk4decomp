...
| **Pure C (no `__asm`)** | **~42%** (1204 / 2839 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2839 functions) |
| Still `__declspec(naked)` | ~48% (1350 / 2839 functions) |
