...
| **Pure C (no `__asm`)** | **~39%** (1109 / 2829 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (294 / 2829 functions) |
| Still `__declspec(naked)` | ~50% (1425 / 2829 functions) |
