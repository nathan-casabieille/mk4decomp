...
| **Pure C (no `__asm`)** | **~42%** (1214 / 2843 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2843 functions) |
| Still `__declspec(naked)` | ~48% (1344 / 2843 functions) |
