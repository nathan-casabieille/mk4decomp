...
| **Pure C (no `__asm`)** | **~42%** (1222 / 2847 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2847 functions) |
| Still `__declspec(naked)` | ~48% (1344 / 2847 functions) |
