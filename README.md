...
| **Pure C (no `__asm`)** | **~42%** (1184 / 2829 functions) - contributions welcome |
...
**The byte-match is done. The C decompilation is not.** About 1644
functions in `src/` (1359 naked + 285 hybrid) still have an
