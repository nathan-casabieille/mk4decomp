...
| **Pure C (no `__asm`)** | **~38%** (1081 / 2829 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~11% (310 / 2829 functions) |
| Still `__declspec(naked)` | ~51% (1437 / 2829 functions) |
