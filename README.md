...
| **Pure C (no `__asm`)** | **~42%** (1195 / 2831 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2831 functions) |
| Still `__declspec(naked)` | ~48% (1351 / 2831 functions) |
