...
| **Pure C (no `__asm`)** | **~42%** (1239 / 2856 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2856 functions) |
| Still `__declspec(naked)` | ~48% (1343 / 2856 functions) |
