...
| **Pure C (no `__asm`)** | **~39%** (1090 / 2829 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~11% (302 / 2829 functions) |
| Still `__declspec(naked)` | ~51% (1436 / 2829 functions) |
