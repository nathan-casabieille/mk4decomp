...
| **Pure C (no `__asm`)** | **~42%** (1193 / 2830 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2830 functions) |
| Still `__declspec(naked)` | ~48% (1352 / 2829 functions) |
