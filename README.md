...
| **Pure C (no `__asm`)** | **~42%** (1203 / 2838 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2838 functions) |
| Still `__declspec(naked)` | ~48% (1350 / 2838 functions) |
