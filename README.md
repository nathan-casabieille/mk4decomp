...
| **Pure C (no `__asm`)** | **~42%** (1237 / 2855 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2855 functions) |
| Still `__declspec(naked)` | ~48% (1343 / 2855 functions) |
