...
| **Pure C (no `__asm`)** | **~42%** (1232 / 2852 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2852 functions) |
| Still `__declspec(naked)` | ~48% (1343 / 2852 functions) |
