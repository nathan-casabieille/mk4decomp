...
| **Pure C (no `__asm`)** | **~42%** (1205 / 2840 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2840 functions) |
| Still `__declspec(naked)` | ~48% (1350 / 2840 functions) |
