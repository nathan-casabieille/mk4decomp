...
| **Pure C (no `__asm`)** | **~42%** (1218 / 2845 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2845 functions) |
| Still `__declspec(naked)` | ~48% (1344 / 2845 functions) |
