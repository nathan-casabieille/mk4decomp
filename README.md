...
| **Pure C (no `__asm`)** | **~42%** (1226 / 2849 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2849 functions) |
| Still `__declspec(naked)` | ~48% (1343 / 2849 functions) |
