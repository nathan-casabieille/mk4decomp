...
| **Pure C (no `__asm`)** | **~42%** (1211 / 2841 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2841 functions) |
| Still `__declspec(naked)` | ~48% (1345 / 2841 functions) |
