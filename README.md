...
| **Pure C (no `__asm`)** | **~42%** (1228 / 2850 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2850 functions) |
| Still `__declspec(naked)` | ~48% (1343 / 2850 functions) |
