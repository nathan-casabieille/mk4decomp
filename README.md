...
| **Pure C (no `__asm`)** | **~42%** (1220 / 2846 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2846 functions) |
| Still `__declspec(naked)` | ~48% (1344 / 2846 functions) |
