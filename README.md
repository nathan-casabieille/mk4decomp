...
| **Pure C (no `__asm`)** | **~42%** (1230 / 2851 functions) - contributions welcome |
| Hybrid (no `naked`, body still `__asm`) | ~10% (285 / 2851 functions) |
| Still `__declspec(naked)` | ~48% (1343 / 2851 functions) |
